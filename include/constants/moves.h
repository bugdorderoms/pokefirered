...
#define SPECIAL_MOVES_START (MOVE_MALIGNANT_CHAIN + 1)

// Z-Moves
#define MOVE_BREAKNECK_BLITZ (SPECIAL_MOVES_START + 0)
#define MOVE_ALL_OUT_PUMMELING (SPECIAL_MOVES_START + 1)
#define MOVE_SUPERSONIC_SKYSTRIKE (SPECIAL_MOVES_START + 2)
#define MOVE_ACID_DOWNPOUR (SPECIAL_MOVES_START + 3)
#define MOVE_TECTONIC_RAGE (SPECIAL_MOVES_START + 4)
#define MOVE_CONTINENTAL_CRUSH (SPECIAL_MOVES_START + 5)
#define MOVE_SAVAGE_SPIN_OUT (SPECIAL_MOVES_START + 6)
#define MOVE_NEVER_ENDING_NIGHTMARE (SPECIAL_MOVES_START + 7)
#define MOVE_CORKSCREW_CRASH (SPECIAL_MOVES_START + 8)
#define MOVE_INFERNO_OVERDRIVE (SPECIAL_MOVES_START + 9)
#define MOVE_HYDRO_VORTEX (SPECIAL_MOVES_START + 10)
#define MOVE_BLOOM_DOOM (SPECIAL_MOVES_START + 11)
#define MOVE_GIGAVOLT_HAVOC (SPECIAL_MOVES_START + 12)
#define MOVE_SHATTERED_PSYCHE (SPECIAL_MOVES_START + 13)
#define MOVE_SUBZERO_SLAMMER (SPECIAL_MOVES_START + 14)
#define MOVE_DEVASTATING_DRAKE (SPECIAL_MOVES_START + 15)
#define MOVE_BLACK_HOLE_ECLIPSE (SPECIAL_MOVES_START + 16)
#define MOVE_TWINKLE_TACKLE (SPECIAL_MOVES_START + 17)
#define MOVE_CATASTROPIKA (SPECIAL_MOVES_START + 18)
#define MOVE_10000000_VOLT_THUNDERBOLT (SPECIAL_MOVES_START + 19)
#define MOVE_STOKED_SPARKSURFER (SPECIAL_MOVES_START + 20)
#define MOVE_EXTREME_EVOBOOST (SPECIAL_MOVES_START + 21)
#define MOVE_PULVERIZING_PANCAKE (SPECIAL_MOVES_START + 22)
#define MOVE_GENESIS_SUPERNOVA (SPECIAL_MOVES_START + 23)
#define MOVE_SINISTER_ARROW_RAID (SPECIAL_MOVES_START + 24)
#define MOVE_MALICIOUS_MOONSAULT (SPECIAL_MOVES_START + 25)
#define MOVE_OCEANIC_OPERETTA (SPECIAL_MOVES_START + 26)
#define MOVE_SPLINTERED_STORMSHARDS (SPECIAL_MOVES_START + 27)
#define MOVE_LETS_SNUGGLE_FOREVER (SPECIAL_MOVES_START + 28)
#define MOVE_CLANGOROUS_SOULBLAZE (SPECIAL_MOVES_START + 29)
#define MOVE_GUARDIAN_OF_ALOLA (SPECIAL_MOVES_START + 30)
#define MOVE_SEARING_SUNRAZE_SMASH (SPECIAL_MOVES_START + 31)
#define MOVE_MENACING_MOONRAZE_MAELSTROM (SPECIAL_MOVES_START + 32)
#define MOVE_LIGHT_THAT_BURNS_THE_SKY (SPECIAL_MOVES_START + 33)
#define MOVE_SOUL_STEALING_7_STAR_STRIKE (SPECIAL_MOVES_START + 34)
...
// Max moves
#define MOVE_GMAX_WILDFIRE (LAST_Z_MOVE + 1)
#define MOVE_GMAX_BEFUDDLE (LAST_Z_MOVE + 2)
#define MOVE_GMAX_VOLT_CRASH (LAST_Z_MOVE + 3)
#define MOVE_GMAX_GOLD_RUSH (LAST_Z_MOVE + 4)
#define MOVE_GMAX_CHI_STRIKE (LAST_Z_MOVE + 5)
#define MOVE_GMAX_TERROR (LAST_Z_MOVE + 6)
#define MOVE_GMAX_RESONANCE (LAST_Z_MOVE + 7)
#define MOVE_GMAX_CUDDLE (LAST_Z_MOVE + 8)
#define MOVE_GMAX_REPLENISH (LAST_Z_MOVE + 9)
#define MOVE_GMAX_MALODOR (LAST_Z_MOVE + 10)
#define MOVE_GMAX_STONESURGE (LAST_Z_MOVE + 11)
#define MOVE_GMAX_WIND_RAGE (LAST_Z_MOVE + 12)
#define MOVE_GMAX_STUN_SHOCK (LAST_Z_MOVE + 13)
#define MOVE_GMAX_FINALE (LAST_Z_MOVE + 14)
#define MOVE_GMAX_DEPLETION (LAST_Z_MOVE + 15)
#define MOVE_GMAX_GRAVITAS (LAST_Z_MOVE + 16)
#define MOVE_GMAX_VOLCALITH (LAST_Z_MOVE + 17)
#define MOVE_GMAX_SANDBLAST (LAST_Z_MOVE + 18)
#define MOVE_GMAX_SNOOZE (LAST_Z_MOVE + 19)
#define MOVE_GMAX_TARTNESS (LAST_Z_MOVE + 20)
#define MOVE_GMAX_SWEETNESS (LAST_Z_MOVE + 21)
#define MOVE_GMAX_SMITE (LAST_Z_MOVE + 22)
#define MOVE_GMAX_STEELSURGE (LAST_Z_MOVE + 23)
#define MOVE_GMAX_MELTDOWN (LAST_Z_MOVE + 24)
#define MOVE_GMAX_FOAM_BURST (LAST_Z_MOVE + 25)
#define MOVE_GMAX_CENTIFERNO (LAST_Z_MOVE + 26)
#define MOVE_GMAX_VINE_LASH (LAST_Z_MOVE + 27)
#define MOVE_GMAX_CANNONADE (LAST_Z_MOVE + 28)
#define MOVE_GMAX_DRUM_SOLO (LAST_Z_MOVE + 29)
#define MOVE_GMAX_FIREBALL (LAST_Z_MOVE + 30)
#define MOVE_GMAX_HYDROSNIPE (LAST_Z_MOVE + 31)
#define MOVE_GMAX_ONE_BLOW (LAST_Z_MOVE + 32)
#define MOVE_GMAX_RAPID_FLOW (LAST_Z_MOVE + 33)
...
#define METRONOME_MOVES_COUNT (SPECIAL_MOVES_START - 1)
