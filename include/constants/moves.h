...
#define MOVE_BLOOD_MOON 827
#define MOVE_MATCHA_GOTCHA 828
#define MOVE_SYRUP_BOMB 829
#define MOVE_IVY_CUDGEL 830
#define MOVE_ELECTRO_SHOT 831
#define MOVE_TERA_STARSTORM 832
#define MOVE_FICKLE_BEAM 833
#define MOVE_BURNING_BULKARK 834
#define MOVE_THUNDERCLAP 835
#define MOVE_MIGHTY_CLEAVE 836
#define MOVE_TACHYON_CUTTER 837
#define MOVE_HARD_PRESS 838
#define MOVE_DRAGON_CHEER 839
#define MOVE_ALLURING_VOICE 840
#define MOVE_TEMPER_FLARE 841
#define MOVE_SUPERCELL_SLAM 842
#define MOVE_PSYCHIC_NOISE 843
#define MOVE_UPPER_HAND 844
#define MOVE_MALIGNANT_CHAIN 845

#define NORMAL_MOVES_END MOVE_MALIGNANT_CHAIN

// Z-Moves
#define MOVE_BREAKNECK_BLITZ (NORMAL_MOVES_END + 1)
#define MOVE_ALL_OUT_PUMMELING (NORMAL_MOVES_END + 2)
#define MOVE_SUPERSONIC_SKYSTRIKE (NORMAL_MOVES_END + 3)
#define MOVE_ACID_DOWNPOUR (NORMAL_MOVES_END + 4)
#define MOVE_TECTONIC_RAGE (NORMAL_MOVES_END + 5)
#define MOVE_CONTINENTAL_CRUSH (NORMAL_MOVES_END + 6)
#define MOVE_SAVAGE_SPIN_OUT (NORMAL_MOVES_END + 7)
#define MOVE_NEVER_ENDING_NIGHTMARE (NORMAL_MOVES_END + 8)
#define MOVE_CORKSCREW_CRASH (NORMAL_MOVES_END + 9)
#define MOVE_INFERNO_OVERDRIVE (NORMAL_MOVES_END + 10)
#define MOVE_HYDRO_VORTEX (NORMAL_MOVES_END + 11)
#define MOVE_BLOOM_DOOM (NORMAL_MOVES_END + 12)
#define MOVE_GIGAVOLT_HAVOC (NORMAL_MOVES_END + 13)
#define MOVE_SHATTERED_PSYCHE (NORMAL_MOVES_END + 14)
#define MOVE_SUBZERO_SLAMMER (NORMAL_MOVES_END + 15)
#define MOVE_DEVASTATING_DRAKE (NORMAL_MOVES_END + 16)
#define MOVE_BLACK_HOLE_ECLIPSE (NORMAL_MOVES_END + 17)
#define MOVE_TWINKLE_TACKLE (NORMAL_MOVES_END + 18)
#define MOVE_CATASTROPIKA (NORMAL_MOVES_END + 19)
#define MOVE_10000000_VOLT_THUNDERBOLT (NORMAL_MOVES_END + 20)
#define MOVE_STOKED_SPARKSURFER (NORMAL_MOVES_END + 21)
#define MOVE_EXTREME_EVOBOOST (NORMAL_MOVES_END + 22)
#define MOVE_PULVERIZING_PANCAKE (NORMAL_MOVES_END + 23)
#define MOVE_GENESIS_SUPERNOVA (NORMAL_MOVES_END + 24)
#define MOVE_SINISTER_ARROW_RAID (NORMAL_MOVES_END + 25)
#define MOVE_MALICIOUS_MOONSAULT (NORMAL_MOVES_END + 26)
#define MOVE_OCEANIC_OPERETTA (NORMAL_MOVES_END + 27)
#define MOVE_SPLINTERED_STORMSHARDS (NORMAL_MOVES_END + 28)
#define MOVE_LETS_SNUGGLE_FOREVER (NORMAL_MOVES_END + 29)
#define MOVE_CLANGOROUS_SOULBLAZE (NORMAL_MOVES_END + 30)
#define MOVE_GUARDIAN_OF_ALOLA (NORMAL_MOVES_END + 31)
#define MOVE_SEARING_SUNRAZE_SMASH (NORMAL_MOVES_END + 32)
#define MOVE_MENACING_MOONRAZE_MAELSTROM (NORMAL_MOVES_END + 33)
#define MOVE_LIGHT_THAT_BURNS_THE_SKY (NORMAL_MOVES_END + 34)
#define MOVE_SOUL_STEALING_7_STAR_STRIKE (NORMAL_MOVES_END + 35)

#define FIRST_Z_MOVE      MOVE_BREAKNECK_BLITZ
#define LAST_TYPED_Z_MOVE MOVE_TWINKLE_TACKLE
#define LAST_Z_MOVE       MOVE_SOUL_STEALING_7_STAR_STRIKE

// Max moves
#define MOVE_MAX_GUARD (LAST_Z_MOVE + 1)
#define MOVE_MAX_FLARE (LAST_Z_MOVE + 2)
#define MOVE_MAX_FLUTTERBY (LAST_Z_MOVE + 3)
#define MOVE_MAX_LIGHTNING (LAST_Z_MOVE + 4)
#define MOVE_MAX_STRIKE (LAST_Z_MOVE + 5)
#define MOVE_MAX_KNUCKLE (LAST_Z_MOVE + 6)
#define MOVE_MAX_PHANTASM (LAST_Z_MOVE + 7)
#define MOVE_MAX_HAILSTORM (LAST_Z_MOVE + 8)
#define MOVE_MAX_OOZE (LAST_Z_MOVE + 9)
#define MOVE_MAX_GEYSER (LAST_Z_MOVE + 10)
#define MOVE_MAX_AIRSTREAM (LAST_Z_MOVE + 11)
#define MOVE_MAX_STARFALL (LAST_Z_MOVE + 12)
#define MOVE_MAX_WYRMWIND (LAST_Z_MOVE + 13)
#define MOVE_MAX_MINDSTORM (LAST_Z_MOVE + 14)
#define MOVE_MAX_ROCKFALL (LAST_Z_MOVE + 15)
#define MOVE_MAX_QUAKE (LAST_Z_MOVE + 16)
#define MOVE_MAX_DARKNESS (LAST_Z_MOVE + 17)
#define MOVE_MAX_OVERGROWTH (LAST_Z_MOVE + 18)
#define MOVE_MAX_STEELSPIKE (LAST_Z_MOVE + 19)

#define FIRST_MAX_MOVE MOVE_MAX_GUARD
#define LAST_MAX_MOVE  MOVE_MAX_STEELSPIKE

// G-Max moves
#define MOVE_GMAX_WILDFIRE (LAST_MAX_MOVE + 1)
#define MOVE_GMAX_BEFUDDLE (LAST_MAX_MOVE + 2)
#define MOVE_GMAX_VOLT_CRASH (LAST_MAX_MOVE + 3)
#define MOVE_GMAX_GOLD_RUSH (LAST_MAX_MOVE + 4)
#define MOVE_GMAX_CHI_STRIKE (LAST_MAX_MOVE + 5)
#define MOVE_GMAX_TERROR (LAST_MAX_MOVE + 6)
#define MOVE_GMAX_RESONANCE (LAST_MAX_MOVE + 7)
#define MOVE_GMAX_CUDDLE (LAST_MAX_MOVE + 8)
#define MOVE_GMAX_REPLENISH (LAST_MAX_MOVE + 9)
#define MOVE_GMAX_MALODOR (LAST_MAX_MOVE + 10)
#define MOVE_GMAX_STONESURGE (LAST_MAX_MOVE + 11)
#define MOVE_GMAX_WIND_RAGE (LAST_MAX_MOVE + 12)
#define MOVE_GMAX_STUN_SHOCK (LAST_MAX_MOVE + 13)
#define MOVE_GMAX_FINALE (LAST_MAX_MOVE + 14)
#define MOVE_GMAX_DEPLETION (LAST_MAX_MOVE + 15)
#define MOVE_GMAX_GRAVITAS (LAST_MAX_MOVE + 16)
#define MOVE_GMAX_VOLCALITH (LAST_MAX_MOVE + 17)
#define MOVE_GMAX_SANDBLAST (LAST_MAX_MOVE + 18)
#define MOVE_GMAX_SNOOZE (LAST_MAX_MOVE + 19)
#define MOVE_GMAX_TARTNESS (LAST_MAX_MOVE + 20)
#define MOVE_GMAX_SWEETNESS (LAST_MAX_MOVE + 21)
#define MOVE_GMAX_SMITE (LAST_MAX_MOVE + 22)
#define MOVE_GMAX_STEELSURGE (LAST_MAX_MOVE + 23)
#define MOVE_GMAX_MELTDOWN (LAST_MAX_MOVE + 24)
#define MOVE_GMAX_FOAM_BURST (LAST_MAX_MOVE + 25)
#define MOVE_GMAX_CENTIFERNO (LAST_MAX_MOVE + 26)
#define MOVE_GMAX_VINE_LASH (LAST_MAX_MOVE + 27)
#define MOVE_GMAX_CANNONADE (LAST_MAX_MOVE + 28)
#define MOVE_GMAX_DRUM_SOLO (LAST_MAX_MOVE + 29)
#define MOVE_GMAX_FIREBALL (LAST_MAX_MOVE + 30)
#define MOVE_GMAX_HYDROSNIPE (LAST_MAX_MOVE + 31)
#define MOVE_GMAX_ONE_BLOW (LAST_MAX_MOVE + 32)
#define MOVE_GMAX_RAPID_FLOW (LAST_MAX_MOVE + 33)

#define FIRST_GMAX_MOVE MOVE_GMAX_WILDFIRE
#define LAST_GMAX_MOVE  MOVE_GMAX_RAPID_FLOW

#define MOVES_COUNT (LAST_GMAX_MOVE + 1)
