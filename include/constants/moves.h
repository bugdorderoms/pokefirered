...
#define MOVE_GMAX_WILDFIRE (MOVES_COUNT_Z + 0)
#define MOVE_GMAX_BEFUDDLE (MOVES_COUNT_Z + 1)
#define MOVE_GMAX_VOLT_CRASH (MOVES_COUNT_Z + 2)
#define MOVE_GMAX_GOLD_RUSH (MOVES_COUNT_Z + 3)
#define MOVE_GMAX_CHI_STRIKE (MOVES_COUNT_Z + 4)
#define MOVE_GMAX_TERROR (MOVES_COUNT_Z + 5)
#define MOVE_GMAX_RESONANCE (MOVES_COUNT_Z + 6)
#define MOVE_GMAX_CUDDLE (MOVES_COUNT_Z + 7)
#define MOVE_GMAX_REPLENISH (MOVES_COUNT_Z + 8)
#define MOVE_GMAX_MALODOR (MOVES_COUNT_Z + 9)
#define MOVE_GMAX_STONESURGE (MOVES_COUNT_Z + 10)
#define MOVE_GMAX_WIND_RAGE (MOVES_COUNT_Z + 11)
#define MOVE_GMAX_STUN_SHOCK (MOVES_COUNT_Z + 12)
#define MOVE_GMAX_FINALE (MOVES_COUNT_Z + 13)
#define MOVE_GMAX_DEPLETION (MOVES_COUNT_Z + 14)
#define MOVE_GMAX_GRAVITAS (MOVES_COUNT_Z + 15)
#define MOVE_GMAX_VOLCALITH (MOVES_COUNT_Z + 16)
#define MOVE_GMAX_SANDBLAST (MOVES_COUNT_Z + 17)
#define MOVE_GMAX_SNOOZE (MOVES_COUNT_Z + 18)
#define MOVE_GMAX_TARTNESS (MOVES_COUNT_Z + 19)
#define MOVE_GMAX_SWEETNESS (MOVES_COUNT_Z + 20)
#define MOVE_GMAX_SMITE (MOVES_COUNT_Z + 21)
#define MOVE_GMAX_STEELSURGE (MOVES_COUNT_Z + 22)
#define MOVE_GMAX_MELTDOWN (MOVES_COUNT_Z + 23)
#define MOVE_GMAX_FOAM_BURST (MOVES_COUNT_Z + 24)
#define MOVE_GMAX_CENTIFERNO (MOVES_COUNT_Z + 25)
#define MOVE_GMAX_VINE_LASH (MOVES_COUNT_Z + 26)
#define MOVE_GMAX_CANNONADE (MOVES_COUNT_Z + 27)
#define MOVE_GMAX_DRUM_SOLO (MOVES_COUNT_Z + 28)
#define MOVE_GMAX_FIREBALL (MOVES_COUNT_Z + 29)
#define MOVE_GMAX_HYDROSNIPE (MOVES_COUNT_Z + 30)
#define MOVE_GMAX_ONE_BLOW (MOVES_COUNT_Z + 31)
#define MOVE_GMAX_RAPID_FLOW (MOVES_COUNT_Z + 32)
