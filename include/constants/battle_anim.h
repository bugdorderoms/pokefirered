...
#define ANIM_TAG_FORCE_PALM                 (ANIM_SPRITES_START + 12)
...
#define ANIM_TAG_PURPLE_DRAKE               (ANIM_SPRITES_START + 19)
...
#define ANIM_TAG_POWER_GEM                  (ANIM_SPRITES_START + 44)
...
#define ANIM_TAG_DRAGON_PULSE_RING          (ANIM_SPRITES_START + 54)
...
#define ANIM_TAG_SMALL_WOOD                 (ANIM_SPRITES_START + 85)
...
#define ANIM_TAG_VINE_2                     (ANIM_SPRITES_START + 117)
#define ANIM_TAG_BIGGEST_ROCK               (ANIM_SPRITES_START + 118)
...
#define ANIM_TAG_SMALL_FISH                 (ANIM_SPRITES_START + 289)
#define ANIM_TAG_PUNISHMENT_BLADES          (ANIM_SPRITES_START + 290)
#define ANIM_TAG_AVALANCHE_ROCKS            (ANIM_SPRITES_START + 291)
#define ANIM_TAG_MUD_BOMB                   (ANIM_SPRITES_START + 292)
