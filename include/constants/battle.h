...
#define HITMARKER_FAINTED(battler)     (Bit(battler) << 28)
#define HITMARKER_FAINTED2(battler)    (Bit(28) << battler) // apparently is unused, but ???

// Per-side statuses that affect an entire party
#define SIDE_STATUS_REFLECT         (1 << 0)
#define SIDE_STATUS_LIGHTSCREEN     (1 << 1)
#define SIDE_STATUS_RAINBOW         (1 << 2)
...
#define SIDE_STATUS_WIDE_GUARD      (1 << 8)
#define SIDE_STATUS_QUICK_GUARD     (1 << 9)
#define SIDE_STATUS_CRAFTY_SHIELD   (1 << 10)
#define SIDE_STATUS_MAT_BLOCK       (1 << 11)
...
#define STATUS_FIELD_WONDER_ROOM      (1 << 9)
...
#define B_TEXT_FLAG_NPC_CONTEXT_FONT Bit(6)
#define B_TEXT_FLAG_WINDOW_CLEAR     Bit(7)
