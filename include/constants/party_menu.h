...
#define FIELD_MOVE_WATERFALL    2
#define FIELD_MOVE_TELEPORT     3
#define FIELD_MOVE_DIG          4
#define FIELD_MOVE_MILK_DRINK   5
#define FIELD_MOVE_SOFT_BOILED  6
#define FIELD_MOVE_SWEET_SCENT  7
#define FIELD_MOVE_DEFOG        8
#define FIELD_MOVE_END          9
...
#define PARTY_MENU_TYPE_CHOOSE_MON          2
...
#define PARTY_MSG_FUSE_WITH_WHICH           27
#define PARTY_MSG_DO_WHAT_WITH_MOVES        28
...
#define SELECTWINDOW_MOVE     4

#define CHOOSE_MONS_FOR_CABLE_CLUB_BATTLE 0
#define CHOOSE_MONS_FOR_UNION_ROOM_BATTLE 1
#define CHOOSE_MONS_FOR_BATTLE_TOWER      2 // Unused

// Wireless minigames
#define WIRELESS_MINIGAME_POKEMON_JUMP  0
#define WIRELESS_MINIGAME_BERRY_PICKING 1
