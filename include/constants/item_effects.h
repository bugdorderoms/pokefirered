...
#define ITEMEFFECT_FRIENDSHIP_LOW    Bit(0)
#define ITEMEFFECT_FRIENDSHIP_MID    Bit(1)
#define ITEMEFFECT_FRIENDSHIP_HIGH   Bit(2)
#define ITEMEFFECT_FRIENDSHIP_MAIN   Bit(3)
