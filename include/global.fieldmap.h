...
struct ObjectEventGraphicsInfo
{
    ...
    /*0x14*/ const union AnimCmd *const *anims;
...
#define PLAYER_AVATAR_FLAG_ON_FOOT        Bit(PLAYER_AVATAR_STATE_NORMAL)
#define PLAYER_AVATAR_FLAG_MACH_BIKE      Bit(PLAYER_AVATAR_STATE_MACH_BIKE)
#define PLAYER_AVATAR_FLAG_ACRO_BIKE      Bit(PLAYER_AVATAR_STATE_ACRO_BIKE)
#define PLAYER_AVATAR_FLAG_SURFING        Bit(PLAYER_AVATAR_STATE_SURFING)
#define PLAYER_AVATAR_FLAG_UNDERWATER     Bit(PLAYER_AVATAR_STATE_UNDERWATER)
#define PLAYER_AVATAR_FLAG_CONTROLLABLE   Bit(PLAYER_AVATAR_STATE_CONTROLLABLE)
#define PLAYER_AVATAR_FLAG_FORCED         Bit(PLAYER_AVATAR_STATE_FORCED)
#define PLAYER_AVATAR_FLAG_DASH           Bit(PLAYER_AVATAR_STATE_DASH)
#define PLAYER_AVATAR_FLAG_TAUROS_RIDE    Bit(PLAYER_AVATAR_STATE_TAUROS_RIDE)
#define PLAYER_AVATAR_FLAG_STOUTLAND_RIDE Bit(PLAYER_AVATAR_STATE_STOUTLAND_RIDE)
#define PLAYER_AVATAR_FLAG_MUDSDALE_RIDE  Bit(PLAYER_AVATAR_STATE_MUDSDALE_RIDE)
#define PLAYER_AVATAR_FLAG_MACHAMP_RIDE   Bit(PLAYER_AVATAR_STATE_MACHAMP_RIDE)
...
// For GetCollisionFlagsAtCoords
#define COLLISION_FLAG_OUTSIDE_RANGE      Bit(COLLISION_OUTSIDE_RANGE - 1)
#define COLLISION_FLAG_IMPASSABLE         Bit(COLLISION_IMPASSABLE - 1)
#define COLLISION_FLAG_ELEVATION_MISMATCH Bit(COLLISION_ELEVATION_MISMATCH - 1)
#define COLLISION_FLAG_OBJECT_EVENT       Bit(COLLISION_OBJECT_EVENT - 1)
