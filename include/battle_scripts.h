...
extern const u8 BattleScript_EffectFoesSpAttackDownHit[];
extern const u8 BattleScript_EffectFoesSpeedDownHit[];
extern const u8 BattleScript_EffectAlliesAttackUpHit[];
extern const u8 BattleScript_EffectFoesDefenseDownHit[];
extern const u8 BattleScript_EffectAlliesSpAttackUpHit[];
extern const u8 BattleScript_EffectAlliesSpeedUpHit[];
extern const u8 BattleScript_EffectFoesAttackDownHit[];
extern const u8 BattleScript_EffectAlliesSpDefUpHit[];
extern const u8 BattleScript_EffectFoesSpDefDownHit[];
extern const u8 BattleScript_EffectAlliesDefenseUpHit[];
extern const u8 BattleScript_EffectGMaxBefuddle[];
extern const u8 BattleScript_EffectGMaxChiStrike[];
extern const u8 BattleScript_EffectGMaxTerror[];
extern const u8 BattleScript_EffectGMaxResonance[];
extern const u8 BattleScript_EffectGMaxWindRage[];
extern const u8 BattleScript_EffectGMaxFinale[];
extern const u8 BattleScript_EffectGMaxSnooze[];
extern const u8 BattleScript_EffectFoesEvasionDownHit[];
extern const u8 BattleScript_EffectAlliesStatusHealHit[];
extern const u8 BattleScript_EffectGMaxMeltdown[];
extern const u8 BattleScript_EffectFoesSpeedDown2Hit[];
// Other scripts
...
extern const u8 BattleScript_RunBattleEndFunctions[];
...
extern const u8 BattleScript_WeatherEnds[];
...
extern const u8 BattleScript_EndTurnEffectEnds[];
...
extern const u8 BattleScript_TrainerSlideMsgEnd3[];
...
extern const u8 BattleScript_NeutralizingGasRemoved[];
...
extern const u8 BattleScript_DoRaidBattleBallThrow[];
...
extern const u8 BattleScript_GigantamaxEnds[];
...
extern const u8 BattleScript_RemoveGimmickOnSwitchOut[];
extern const u8 BattleScript_RemoveGimmickOnFainting[];
extern const u8 BattleScript_ChangeFormOnSwitchOut[];
extern const u8 BattleScript_RaidShieldBreak[];
extern const u8 BattleScript_MoveEffectSetWeather[];
extern const u8 BattleScript_MoveEffectDamageNonTypes[];
extern const u8 BattleScript_DamageNonTypesTurnDmg[];
extern const u8 BattleScript_MoveEffectInfatuation[];
extern const u8 BattleScript_MoveEffectStealthRock[];
extern const u8 BattleScript_MoveEffectSetGravity[];
extern const u8 BattleScript_MoveEffectSteelsurge[];
extern const u8 BattleScript_CouldntFullyProtect[];
extern const u8 BattleScript_CreateRaidShields[];
extern const u8 BattleScript_RaidBattleStatNullification[];
extern const u8 BattleScript_LearnMoveYesNoBox[];
extern const u8 BattleScript_CatchRaidBossYesNoBox[];
extern const u8 BattleScript_GiveNicknameYesNoBox[];
extern const u8 BattleScript_RaidCheerMessage[];

extern const u8 *const gBattlescriptsForUsingItem[];
extern const u8 *const gRaidCheerEffectsTable[];
