...
enum
{
    MOVE_INFO_POKEBALL_ICON,
    MOVE_INFO_MOVE_TYPE_ICON,
    MOVE_INFO_POWER_TEXT_ICON = MOVE_INFO_MOVE_TYPE_ICON + NUMBER_OF_MON_TYPES,
    MOVE_INFO_ACCURACY_TEXT_ICON,
    MOVE_INFO_PP_TEXT_ICON,
    MOVE_INFO_EFFECT_TEXT_ICON,
    MOVE_INFO_TYPE_TEXT_ICON,
    MOVE_INFO_CATEGORY_TEXT_INFO,
    MOVE_INFO_MOVE_SPLIT_ICON,
    MOVE_INFO_IV_RANKING_ICON = MOVE_INFO_MOVE_SPLIT_ICON + NUM_MOVE_SPLITS,
    MOVE_INFO_ICON_END = MOVE_INFO_IV_RANKING_ICON + 16,
};
