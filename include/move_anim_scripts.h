#ifndef GUARD_MOVE_ANIM_SCRIPTS_H
#define GUARD_MOVE_ANIM_SCRIPTS_H
...
extern const u8 Move_HI_JUMP_KICK[];
...
extern const u8 Move_FAINT_ATTACK[];
...
extern const u8 Move_SMELLING_SALT[];
...
extern const u8 Move_BURNING_BULKARK[];
...
extern const u8 Move_GMAX_WILDFIRE[];
extern const u8 Move_GMAX_BEFUDDLE[];
extern const u8 Move_GMAX_VOLT_CRASH[];
extern const u8 Move_GMAX_GOLD_RUSH[];
extern const u8 Move_GMAX_CHI_STRIKE[];
extern const u8 Move_GMAX_TERROR[];
extern const u8 Move_GMAX_RESONANCE[];
extern const u8 Move_GMAX_CUDDLE[];
extern const u8 Move_GMAX_REPLENISH[];
extern const u8 Move_GMAX_MALODOR[];
extern const u8 Move_GMAX_STONESURGE[];
extern const u8 Move_GMAX_WIND_RAGE[];
extern const u8 Move_GMAX_STUN_SHOCK[];
extern const u8 Move_GMAX_FINALE[];
extern const u8 Move_GMAX_DEPLETION[];
extern const u8 Move_GMAX_GRAVITAS[];
extern const u8 Move_GMAX_VOLCALITH[];
extern const u8 Move_GMAX_SANDBLAST[];
extern const u8 Move_GMAX_SNOOZE[];
extern const u8 Move_GMAX_TARTNESS[];
extern const u8 Move_GMAX_SWEETNESS[];
extern const u8 Move_GMAX_SMITE[];
extern const u8 Move_GMAX_STEELSURGE[];
extern const u8 Move_GMAX_MELTDOWN[];
extern const u8 Move_GMAX_FOAM_BURST[];
extern const u8 Move_GMAX_CENTIFERNO[];
extern const u8 Move_GMAX_VINE_LASH[];
extern const u8 Move_GMAX_CANNONADE[];
extern const u8 Move_GMAX_DRUM_SOLO[];
extern const u8 Move_GMAX_FIREBALL[];
extern const u8 Move_GMAX_HYDROSNIPE[];
extern const u8 Move_GMAX_ONE_BLOW[];
extern const u8 Move_GMAX_RAPID_FLOW[];

#endif // GUARD_MOVE_ANIM_SCRIPTS_H
