...
extern const u8 gText_DoWhatWithMoves[];
...
extern const u8 gText_AbilityChanged[];
...
extern const u8 gText_PkmnNoMovesToRemember[];
extern const u8 gText_PkmnCantForget[];
extern const u8 gText_PkmnForgotMove[];
...
extern const u8 gText_PkmnBaseVar2StatVar3[];
extern const u8 gText_PkmnFriendshipWasVar2[];
extern const u8 gText_Increased[];
extern const u8 gText_Decreased[];
...
extern const u8 gOtherText_DefaultForm[];
extern const u8 gText_DeoxysFormAttack[];
extern const u8 gText_DeoxysFormDefense[];
extern const u8 gText_DeoxysFormSpeed[];
extern const u8 gText_RotomFormHeat[];
extern const u8 gText_RotomFormWash[];
extern const u8 gText_RotomFormFrost[];
extern const u8 gText_RotomFormFan[];
extern const u8 gText_RotomFormMow[];
extern const u8 gText_PikachuFormRockStar[];
extern const u8 gText_PikachuFormBelle[];
extern const u8 gText_PikachuFormPopStar[];
extern const u8 gText_PikachuFormPhd[];
extern const u8 gText_PikachuFormLibre[];
extern const u8 gText_FurfrouFormHeartTrim[];
extern const u8 gText_FurfrouFormStarTrim[];
extern const u8 gText_FurfrouFormDiamondTrim[];
extern const u8 gText_FurfrouFormDebutanteTrim[];
extern const u8 gText_FurfrouFormMatronTrim[];
extern const u8 gText_FurfrouFormDandyTrim[];
extern const u8 gText_FurfrouFormLaReineTrim[];
extern const u8 gText_FurfrouFormKabukiTrim[];
extern const u8 gText_FurfrouFormPharaohTrim[];
...
extern const u8 gText_TmPurchased[];
