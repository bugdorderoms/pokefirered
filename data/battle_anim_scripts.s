...
General_FormChange::
	monbg ANIM_TARGET
	createvisualtask AnimTask_TransformMon, 2, SPECIESGFX_FLAG_NO_TRANSFORM_PALFADE
	waitforvisualfinish
...
@ Credits: Blackuser
Move_KARATE_CHOP::
	loadspritegfx ANIM_TAG_KARATE_HAND
	loadspritegfx ANIM_TAG_IMPACT
	monbg ANIM_TARGET
	setalpha 12, 8
...
Move_STOMP:: @ 81C82CA
	...
	createsprite gStompFootSpriteTemplate, ANIM_ATTACKER, 3, 0, -32, 15, 0
	delay 19
...
Move_TRANSFORM:: @ 81D2811
	...
	createvisualtask AnimTask_TransformMon, 2, 
	waitforvisualfinish
	clearmonbg ANIM_ATTACKER
	end
...
General_SilphScoped:: @ 81D637B
	...
	playsewithpan SE_M_TELEPORT, 192
	waitplaysewithpan SE_M_MINIMIZE, 192, 48
	createvisualtask AnimTask_TransformMon, 2, SPECIESGFX_FLAG_IS_GHOST
	waitsound
	waitforvisualfinish
	clearmonbg ANIM_ATTACKER
	end
