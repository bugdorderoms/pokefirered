...
{
    if (itemId - FIRST_BERRY_INDEX < 0 || itemId - FIRST_BERRY_INDEX > LAST_BERRY_INDEX - FIRST_BERRY_INDEX)
        return 1;
...
{
    if (berryType - 1 < 0 || berryType - 1 > LAST_BERRY_INDEX - FIRST_BERRY_INDEX)
