...
static void Task_DoFusionWhiteScreen(u32 taskId);
static void Task_DoMosaicFormChangeAnim(u32 taskId);
static void Task_DoGracideaFlowersFormChangeAnim(u32 taskId);
static void Task_DoPurpleCloudFormChangeAnim(u32 taskId);
static void Task_DoLightAbsorptionFormChangeAnim(u32 taskId);
static void Task_DoClosingScreenFormChangeAnim(u32 taskId);
static void Task_DoFallingFeathersFormChangeAnim(u32 taskId);
...
static void Task_PlayMonCryAfterFormChangeAnim(u32 taskId)
{
