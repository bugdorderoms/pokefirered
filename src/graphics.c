...
const u8 gUnknown_84566A8[] = INCBIN_U8("graphics/interface/unknown_4566a8.bin");
...
const u32 gUnknown_8E9CAEC[] = INCBIN_U32("graphics/interface/unknown_E9CAEC.bin.lz");
