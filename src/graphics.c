...
#include "data/item/interface_pokeballs.h"
...
const u32 gBattleAnimSpriteGfx_KarateHand[] = INCBIN_U32("graphics/battle_anims/sprites/karate_hand.4bpp.lz");
...
#include "data/trainer/trainer_pics.h"
