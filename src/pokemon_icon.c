...
const u8 *const gMonIconTable[] = {
    ...
    [SPECIES_MINIOR] = gMonIcon_MiniorCoreRed,
    ...
    [SPECIES_UNFEZANT_FEMALE] = gMonIcon_UnfezantFemale,
    ...
    [SPECIES_MINIOR_METEOR] = gMonIcon_MiniorMeteor,
    ...
    /*[SPECIES_VENUSAUR_GIGA] = gMonIcon_VenusaurGiga,
    [SPECIES_CHARIZARD_GIGA] = gMonIcon_CharizardGiga,
    [SPECIES_BLASTOISE_GIGA] = gMonIcon_BlastoiseGiga,
    [SPECIES_BUTTERFREE_GIGA] = gMonIcon_ButterfreeGiga,
    [SPECIES_PIKACHU_GIGA] = gMonIcon_PikachuGiga,
    [SPECIES_MEOWTH_GIGA] = gMonIcon_MeowthGiga,
    [SPECIES_MACHAMP_GIGA] = gMonIcon_MachampGiga,
    [SPECIES_GENGAR_GIGA] = gMonIcon_GengarGiga,
    [SPECIES_KINGLER_GIGA] = gMonIcon_KinglerGiga,
    [SPECIES_LAPRAS_GIGA] = gMonIcon_LaprasGiga,
    [SPECIES_EEVEE_GIGA] = gMonIcon_EeveeGiga,
    [SPECIES_SNORLAX_GIGA] = gMonIcon_SnorlaxGiga,
    [SPECIES_GARBODOR_GIGA] = gMonIcon_GarbodorGiga,
    [SPECIES_MELMETAL_GIGA] = gMonIcon_MelmetalGiga,
    [SPECIES_RILLABOOM_GIGA] = gMonIcon_RillaboomGiga,
    [SPECIES_CINDERACE_GIGA] = gMonIcon_QuestionMark,//gMonIcon_CinderaceGiga,
    [SPECIES_INTELEON_GIGA] = gMonIcon_QuestionMark,//gMonIcon_InteleonGiga,
    [SPECIES_CORVIKNIGHT_GIGA] = gMonIcon_CorviknightGiga,
    [SPECIES_ORBEETLE_GIGA] = gMonIcon_OrbeetleGiga,
    [SPECIES_DREDNAW_GIGA] = gMonIcon_DrednawGiga,
    [SPECIES_COALOSSAL_GIGA] = gMonIcon_CoalossalGiga,
    [SPECIES_FLAPPLE_GIGA] = gMonIcon_FlappleGiga,
    [SPECIES_APPLETUN_GIGA] = gMonIcon_FlappleGiga,
    [SPECIES_SANDACONDA_GIGA] = gMonIcon_SandacondaGiga,
    [SPECIES_TOXTRICITY_GIGA] = gMonIcon_ToxtricityGiga,
    [SPECIES_TOXTRICITY_LOW_KEY_GIGA] = gMonIcon_ToxtricityGiga,
    [SPECIES_CENTISKORCH_GIGA] = gMonIcon_CentiskorchGiga,
    [SPECIES_HATTERENE_GIGA] = gMonIcon_HattereneGiga,
    [SPECIES_GRIMMSNARL_GIGA] = gMonIcon_GrimmsnarlGiga,
    [SPECIES_ALCREMIE_GIGA] = gMonIcon_AlcremieGiga,
    [SPECIES_COPPERAJAH_GIGA] = gMonIcon_CopperajahGiga,
    [SPECIES_DURALUDON_GIGA] = gMonIcon_DuraludonGiga,
    [SPECIES_URSHIFU_GIGA] = gMonIcon_UrshifuGiga,
    [SPECIES_URSHIFU_RAPID_STRIKE_GIGA] = gMonIcon_UrshifuRapidStrikeStyleGiga,*/
    ...
    [SPECIES_BASCULEGION_FEMALE] = gMonIcon_QuestionMark,//gMonIcon_BasculegionFemale,
