...
u16 GetNationalPokedexCount(u8 caseId)
{
    ...
    for (i = 0, count = 0; i < NATIONAL_DEX_COUNT; i++)
    {
...
u16 GetKantoPokedexCount(u8 caseId)
{
    ...
    for (i = 0, count = 0; i < KANTO_DEX_COUNT; i++)
    {
		if (GetSetPokedexFlag(i + 1, caseId))
			++count;
    }
...
{
    return species == SPECIES_NONE ? NATIONAL_DEX_NONE : sSpeciesToNationalPokedexNum[species - 1];
}
