const struct BattleMove gBattleMoves[MOVES_COUNT] =
{
    ...
    [MOVE_FLY] =
    {
        ...
        .argument = {
            .twoTurns = {
                ...
                .statusOrweather = COMPRESS_BITS(STATUS3_ON_AIR)
            }
        },
        .split = SPLIT_PHYSICAL,
        .zMoveEffect = Z_EFFECT_NONE,
    ...
    [MOVE_SOLAR_BEAM] =
    {
        ...
        .argument = {
            .twoTurns = {
                ...
                .statusOrweather = B_WEATHER_SUN_ANY
            }
        },
        .split = SPLIT_SPECIAL,
        .zMoveEffect = Z_EFFECT_NONE,
    ...
    [MOVE_DIG] =
    {
        ...
        .argument = {
            .twoTurns = {
                ...
                .statusOrweather = COMPRESS_BITS(STATUS3_UNDERGROUND)
            }
        },
        .split = SPLIT_PHYSICAL,
        .zMoveEffect = Z_EFFECT_NONE,
    ...
    [MOVE_RAGE] =
    {
        ...
        .argument = {
            .setStatus = {
                .statusId = ID_STATUS2,
                .status = COMPRESS_BITS(STATUS2_RAGE)
            }
        },
        .split = SPLIT_PHYSICAL,
        .zMoveEffect = Z_EFFECT_NONE,
    ...
    [MOVE_MINIMIZE] =
    {
        ...
        .effect = EFFECT_EVASION_UP_SET_ATTACKER_STATUS,
        .type = TYPE_NORMAL,
        .pp = 10,
        .target = MOVE_TARGET_USER,
        .flags =
        ...
        .argument = {
            .setStatus = {
                .statusId = ID_STATUS3,
                .status = COMPRESS_BITS(STATUS3_MINIMIZED)
            }
        },
        .zMoveEffect = Z_EFFECT_RESET_STATS,
    },
    ...
    [MOVE_DEFENSE_CURL] =
    {
        ...
        .effect = EFFECT_DEFENSE_UP_SET_ATTACKER_STATUS,
        .type = TYPE_NORMAL,
        .pp = 40,
        .target = MOVE_TARGET_USER,
        .flags =
        ...
        .argument = {
            .setStatus = {
                .statusId = ID_STATUS2,
                .status = COMPRESS_BITS(STATUS2_DEFENSE_CURL)
            }
        },
        .zMoveEffect = Z_EFFECT_ACC_UP_1,
    },
    ...
    [MOVE_FOCUS_ENERGY] =
    {
        ...
        .effect = EFFECT_SET_ATTACKER_STATUS,
        .type = TYPE_NORMAL,
        .pp = 30,
        .target = MOVE_TARGET_USER,
        .flags =
        ...
        .argument = {
            .setStatus = {
                .statusId = ID_STATUS2,
                .status = COMPRESS_BITS(STATUS2_FOCUS_ENERGY),
                .stringId = B_MSG_GET_PUMPED
            }
        },
        .zMoveEffect = Z_EFFECT_ACC_UP_1,
    },
    ...
    [MOVE_NIGHTMARE] =
    {
        ...
        .argument = {
            .setStatus = {
                .statusId = ID_STATUS2,
                .status = COMPRESS_BITS(STATUS2_NIGHTMARE),
                .stringId = B_MSG_BEGAN_NIGHTMARE
            }
        },
        .zMoveEffect = Z_EFFECT_SPATK_UP_1,
    },
    ...
    [MOVE_CURSE] =
    {
        ...
        .argument = {
            .setStatus = {
                .statusId = ID_STATUS2,
                .status = COMPRESS_BITS(STATUS2_CURSED),
                .stringId = B_MSG_LAID_CURSE
            }
        },
    ...
    [MOVE_FORESIGHT] =
    {
        ...
        .effect = EFFECT_SET_TARGET_STATUS,
        .type = TYPE_NORMAL,
        .pp = 40,
        .target = MOVE_TARGET_SELECTED,
        .flags =
        ...
        .argument = {
            .setStatus = {
                .statusId = ID_STATUS2,
                .status = COMPRESS_BITS(STATUS2_FORESIGHT),
                .stringId = B_MSG_IDENTIFIED
            }
        },
    ...
    [MOVE_SANDSTORM] =
    {
        ...
        .flags =
        {
            .forbiddenProtect = TRUE,
            .forbiddenMirrorMove = TRUE,
            .windMove = TRUE, // Only set for data purpose, no wind ability can activate due to this
        },
        .split = SPLIT_STATUS,
        .argument = {
            .setWeather = {
    ...
    [MOVE_INGRAIN] =
    {
        ...
        .argument = {
            .setStatus = {
                .statusId = ID_STATUS3,
                .status = COMPRESS_BITS(STATUS3_ROOTED),
                .stringId = B_MSG_PLANTED_ROOTS
            }
        },
        .zMoveEffect = Z_EFFECT_SPDEF_UP_1,
    },
    ...
    [MOVE_IMPRISON] =
    {
        ...
        .argument = {
            .setStatus = {
                .statusId = ID_STATUS3,
                .status = COMPRESS_BITS(STATUS3_IMPRISONED_OTHERS),
                .stringId = B_MSG_SEALED_MOVE
            }
        },
        .zMoveEffect = Z_EFFECT_SPDEF_UP_2,
    },
    ...
    [MOVE_GRUDGE] =
    {
        ...
        .argument = {
            .setStatus = {
                .statusId = ID_STATUS3,
                .status = COMPRESS_BITS(STATUS3_GRUDGE),
                .stringId = B_MSG_TARGET_BEAR_GRUDGE
            }
        },
        .zMoveEffect = Z_EFFECT_FOLLOW_ME,
    },
    ...
    [MOVE_DIVE] =
    {
        ...
        .argument = {
            .twoTurns = {
                ...
                .statusOrweather = COMPRESS_BITS(STATUS3_UNDERWATER)
            }
        },
        .split = SPLIT_PHYSICAL,
        .zMoveEffect = Z_EFFECT_NONE,
    ...
    [MOVE_MIRACLE_EYE] =
    {
        ...
        .argument = {
            .setStatus = {
                .statusId = ID_STATUS2,
                .status = COMPRESS_BITS(STATUS2_MIRACLE_EYE),
                .stringId = B_MSG_IDENTIFIED
            }
        },
        .zMoveEffect = Z_EFFECT_SPATK_UP_1,
    ...
    [MOVE_TAILWIND] =
    {
        ...
        .flags =
        {
            ...
            .forbiddenProtect = TRUE,
            .forbiddenMirrorMove = TRUE,
            .windMove = TRUE, // Only set for data purpose, wind abilities are handled separated
        },
        .split = SPLIT_STATUS,
        .zMoveEffect = Z_EFFECT_BOOST_CRITS,
    },
    ...
    [MOVE_AQUA_RING] =
    {
        ...
        .description = COMPOUND_STRING("It envelops itself\n"
                                       "in a veil made of\n"
                                       "water. It regains\n"
                                       "some HP every turn."),
        .animScript = gMoveAnim_AQUA_RING,
        .effect = EFFECT_SET_ATTACKER_STATUS,
        .type = TYPE_WATER,
        .pp = 20,
        .target = MOVE_TARGET_USER,
        ...
        .argument = {
            .setStatus = {
                .statusId = ID_STATUS2,
                .status = COMPRESS_BITS(STATUS2_AQUA_RING),
                .stringId = B_MSG_SURROUNDED_IN_VEIL_OF_WATER
            }
        },
        .zMoveEffect = Z_EFFECT_DEF_UP_1,
    },
    ...
    [MOVE_MAGNET_RISE] =
    {
        ...
        .description = COMPOUND_STRING("The user levitates\n"
                                       "using electrically\n"
                                       "generated magnetism\n"
                                       "for five turns."),
        .animScript = gMoveAnim_MAGNET_RISE,
    ...
    [MOVE_FLARE_BLITZ] =
    {
        ...
        .description = COMPOUND_STRING("It cloaks in fire\n"
                                       "and charges at the\n"
                                       "foe. It sustains\n"
                                       "serious damage, too."),
        .animScript = gMoveAnim_FLARE_BLITZ,
        .effect = EFFECT_HIT,
        .power = 120,
        .type = TYPE_FIRE,
        .accuracy = 100,
    ...
    [MOVE_FORCE_PALM] =
    {
        ...
        .description = COMPOUND_STRING("The foe is attacked\n"
                                       ...
                                       "It may also leave\n"
                                       "the foe paralyzed."),
        .animScript = gMoveAnim_FORCE_PALM,
        .effect = EFFECT_HIT,
        .power = 60,
        .type = TYPE_FIGHTING,
        .accuracy = 100,
    ...
    [MOVE_AURA_SPHERE] =
    {
        ...
        .description = COMPOUND_STRING("Looses a blast of\n"
                                       "aura from deep\n"
                                       "within its body. It\n"
                                       "is certain to hit."),
        .animScript = gMoveAnim_AURA_SPHERE,
        .effect = EFFECT_HIT,
        .power = 80,
        .type = TYPE_FIGHTING,
        .pp = 20,
    ...
    [MOVE_ROCK_POLISH] =
    {
        ...
        .description = COMPOUND_STRING("It polishes its\n"
                                       "body to reduce\n"
                                       "drag. This sharply\n"
                                       "raises its Speed."),
        .animScript = gMoveAnim_ROCK_POLISH,
        .effect = EFFECT_SPEED_UP_2,
        .type = TYPE_ROCK,
        .pp = 20,
        .target = MOVE_TARGET_USER,
    ...
    [MOVE_POISON_JAB] =
    {
        ...
        .description = COMPOUND_STRING("The foe is stabbed\n"
                                       ...
                                       "in poison. It may\n"
                                       "also poison the foe."),
        .animScript = gMoveAnim_POISON_JAB,
        .effect = EFFECT_HIT,
        .power = 80,
        .type = TYPE_POISON,
        .accuracy = 100,
    ...
    [MOVE_DARK_PULSE] =
    {
        ...
        .description = COMPOUND_STRING("The user releases a\n"
                                       "horrible ill intent\n"
                                       "aura. It may also\n"
                                       "make the foe flinch."),
        .animScript = gMoveAnim_DARK_PULSE,
        .effect = EFFECT_HIT,
        .power = 80,
        .type = TYPE_DARK,
        .accuracy = 100,
    ...
    [MOVE_NIGHT_SLASH] =
    {
        ...
        .description = COMPOUND_STRING("It slashes the foe\n"
                                       ...
                                       "arises. It has a\n"
                                       "high critical ratio."),
        .animScript = gMoveAnim_NIGHT_SLASH,
        .effect = EFFECT_HIT,
        .power = 70,
        .type = TYPE_DARK,
        .accuracy = 100,
    ...
    [MOVE_AQUA_TAIL] =
    {
        ...
        .description = COMPOUND_STRING("The user attacks by\n"
                                       ...
                                       "as if it were a\n"
                                       "wave in a storm."),
        .animScript = gMoveAnim_AQUA_TAIL,
        .effect = EFFECT_HIT,
        .power = 90,
        .type = TYPE_WATER,
        .accuracy = 90,
    ...
    [MOVE_SEED_BOMB] =
    {
        ...
        .description = COMPOUND_STRING("It slams a barrage\n"
                                       "of hard-shelled\n"
                                       "seeds down on the\n"
                                       "foe from above."),
        .animScript = gMoveAnim_SEED_BOMB,
        .effect = EFFECT_HIT,
        .power = 80,
        .type = TYPE_GRASS,
        .accuracy = 100,
    ...
    [MOVE_AIR_SLASH] =
    {
        ...
        .description = COMPOUND_STRING("The user attacks\n"
                                       ...
                                       "air. It may also\n"
                                       "make the foe flinch."),
        .animScript = gMoveAnim_AIR_SLASH,
        .effect = EFFECT_HIT,
        .power = 75,
        .type = TYPE_FLYING,
        .accuracy = 95,
    ...
    [MOVE_X_SCISSOR] =
    {
        ...
        .description = COMPOUND_STRING("The user slashes at\n"
                                       ...
                                       "its claws as if\n"
                                       "they were scissors."),
        .animScript = gMoveAnim_X_SCISSOR,
        .effect = EFFECT_HIT,
        .power = 80,
        .type = TYPE_BUG,
        .accuracy = 100,
    ...
    [MOVE_BUG_BUZZ] =
    {
        ...
        .description = COMPOUND_STRING("It vibrates a sound\n"
                                       "wave to attack. It\n"
                                       "may also lower the\n"
                                       "foe's Sp. Def stat."),
        .animScript = gMoveAnim_BUG_BUZZ,
        .effect = EFFECT_HIT,
        .power = 90,
        .type = TYPE_BUG,
        .accuracy = 100,
    ...
    [MOVE_DRAGON_PULSE] =
    {
        ...
        .description = COMPOUND_STRING("The foe is attacked\n"
                                       ...
                                       "generated by the\n"
                                       "user's gaping mouth."),
        .animScript = gMoveAnim_DRAGON_PULSE,
        .effect = EFFECT_HIT,
        .power = 85,
        .type = TYPE_DRAGON,
        .accuracy = 100,
    ...
    [MOVE_DRAGON_RUSH] =
    {
        ...
        .description = COMPOUND_STRING("It tackles the foe\n"
                                       "while exhibiting\n"
                                       "menace. It may also\n"
                                       "make the foe flinch."),
        .animScript = gMoveAnim_DRAGON_RUSH,
        .effect = EFFECT_HIT,
        .power = 100,
        .type = TYPE_DRAGON,
        .accuracy = 75,
    ...
    [MOVE_POWER_GEM] =
    {
        ...
        .description = COMPOUND_STRING("Attacks with a ray\n"
                                       "of light that\n"
                                       "sparkles as if it\n"
                                       "were made of gems."),
        .animScript = gMoveAnim_POWER_GEM,
        .effect = EFFECT_HIT,
        .power = 80,
        .type = TYPE_ROCK,
        .accuracy = 100,
    ...
    [MOVE_DRAIN_PUNCH] =
    {
        ...
        .description = COMPOUND_STRING("An energy-draining\n"
                                       "punch. The user's\n"
                                       "HP is restored by\n"
                                       "half the damage."),
        .animScript = gMoveAnim_DRAIN_PUNCH,
        .effect = EFFECT_HIT_ABSORB,
        .power = 75,
        .type = TYPE_FIGHTING,
        .accuracy = 100,
    ...
    [MOVE_VACUUM_WAVE] =
    {
        ...
        .description = COMPOUND_STRING("It whirls its fists\n"
                                       "to send a vacuum\n"
                                       "wave at the foe. It\n"
                                       "always goes first."),
        .animScript = gMoveAnim_VACUUM_WAVE,
        .effect = EFFECT_HIT,
        .power = 40,
        .type = TYPE_FIGHTING,
        .accuracy = 100,
    ...
    [MOVE_FOCUS_BLAST] =
    {
        ...
        .description = COMPOUND_STRING("Heightens its focus\n"
                                       "and unleashes its\n"
                                       "power. It may lower\n"
                                       "the foe's Sp. Def."),
        .animScript = gMoveAnim_FOCUS_BLAST,
        .effect = EFFECT_HIT,
        .power = 120,
        .type = TYPE_FIGHTING,
        .accuracy = 70,
    ...
    [MOVE_ENERGY_BALL] =
    {
        ...
        .description = COMPOUND_STRING("It draws power from\n"
                                       "nature and fires\n"
                                       "it. It may lower\n"
                                       "the foe's Sp. Def."),
        .animScript = gMoveAnim_ENERGY_BALL,
        .effect = EFFECT_HIT,
        .power = 90,
        .type = TYPE_GRASS,
        .accuracy = 100,
    ...
    [MOVE_BRAVE_BIRD] =
    {
        ...
        .description = COMPOUND_STRING("The user tucks in\n"
                                       ...
                                       "altitude. It also\n"
                                       "damages the user."),
        .animScript = gMoveAnim_BRAVE_BIRD,
        .effect = EFFECT_HIT,
        .power = 120,
        .type = TYPE_FLYING,
        .accuracy = 100,
    ...
    [MOVE_EARTH_POWER] =
    {
        ...
        .description = COMPOUND_STRING("Makes the ground\n"
                                       "under the foe\n"
                                       "erupt. It may lower\n"
                                       "the foe's Sp. Def."),
        .animScript = gMoveAnim_EARTH_POWER,
        .effect = EFFECT_HIT,
        .power = 90,
        .type = TYPE_GROUND,
        .accuracy = 100,
    ...
    [MOVE_SWITCHEROO] =
    {
        ...
        .description = COMPOUND_STRING("The user trades\n"
                                       "held items with the\n"
                                       "target faster than\n"
                                       "the eye can follow."),
        .animScript = gMoveAnim_SWITCHEROO,
        .effect = EFFECT_TRICK,
        .type = TYPE_DARK,
        .accuracy = 100,
        .pp = 10,
    ...
    [MOVE_GIGA_IMPACT] =
    {
        ...
        .description = COMPOUND_STRING("Charges at the foe\n"
                                       "using its full\n"
                                       "power. It must rest\n"
                                       "on the next turn."),
        .animScript = gMoveAnim_GIGA_IMPACT,
        .effect = EFFECT_HIT,
        .power = 150,
        .type = TYPE_NORMAL,
        .accuracy = 90,
    ...
    [MOVE_NASTY_PLOT] =
    {
        ...
        .description = COMPOUND_STRING("Stimulates its\n"
                                       "brain thinking bad\n"
                                       "thoughts. Sharply\n"
                                       "raising its Sp. Atk."),
        .animScript = gMoveAnim_NASTY_PLOT,
    ...
    [MOVE_BULLET_PUNCH] =
    {
        ...
        .description = COMPOUND_STRING("It strikes with a\n"
                                       "tough punch as fast\n"
                                       "as a bullet. It\n"
                                       "always goes first."),
        .animScript = gMoveAnim_BULLET_PUNCH,
        .effect = EFFECT_HIT,
        .power = 40,
        .type = TYPE_STEEL,
        .accuracy = 100,
    ...
    [MOVE_AVALANCHE] =
    {
        ...
        .description = COMPOUND_STRING("An attack move that\n"
                                       ...
                                       "if the target has\n"
                                       "hurt the user."),
        .animScript = gMoveAnim_AVALANCHE,
        .effect = EFFECT_REVENGE,
        .power = 60,
        .type = TYPE_ICE,
        .accuracy = 100,
    ...
    [MOVE_ICE_SHARD] =
    {
        ...
        .description = COMPOUND_STRING("The user flash\n"
                                       "freezes chunks of\n"
                                       "ice and hurls them.\n"
                                       "Always goes first."),
        .animScript = gMoveAnim_ICE_SHARD,
        .effect = EFFECT_HIT,
        .power = 40,
        .type = TYPE_ICE,
        .accuracy = 100,
    ...
    [MOVE_SHADOW_CLAW] =
    {
        ...
        .description = COMPOUND_STRING("Slashes with a claw\n"
                                       ...
                                       "It has a high\n"
                                       "critical-hit ratio."),
        .animScript = gMoveAnim_SHADOW_CLAW,
        .effect = EFFECT_HIT,
        .power = 70,
        .type = TYPE_GHOST,
        .accuracy = 100,
    ...
    [MOVE_THUNDER_FANG] =
    {
        ...
        .description = COMPOUND_STRING("It bites with\n"
                                       "electric fangs. May\n"
                                       "make the foe flinch\n"
                                       "or become paralyzed."),
        .animScript = gMoveAnim_THUNDER_FANG,
        .effect = EFFECT_HIT,
        .power = 65,
        .type = TYPE_ELECTRIC,
        .accuracy = 95,
    ...
    [MOVE_FIRE_FANG] =
    {
        ...
        .description = COMPOUND_STRING("It bites with flame\n"
                                       "fangs. It may also\n"
                                       "make the foe flinch\n"
                                       "or leave it burned."),
        .animScript = gMoveAnim_FIRE_FANG,
        .effect = EFFECT_HIT,
        .power = 65,
        .type = TYPE_FIRE,
        .accuracy = 95,
    ...
    [MOVE_SHADOW_SNEAK] =
    {
        ...
        .description = COMPOUND_STRING("It extends its\n"
                                       "shadow and attacks\n"
                                       "from behind. It\n"
                                       "always goes first."),
        .animScript = gMoveAnim_SHADOW_SNEAK,
        .effect = EFFECT_HIT,
        .power = 40,
        .type = TYPE_GHOST,
        .accuracy = 100,
    ...
    [MOVE_MUD_BOMB] =
    {
        ...
        .description = COMPOUND_STRING("It launches a\n"
                                       "hard-packed mud\n"
                                       "ball. It may lower\n"
                                       "the foe's accuracy."),
        .animScript = gMoveAnim_MUD_BOMB,
        .effect = EFFECT_HIT,
        .power = 65,
        .type = TYPE_GROUND,
        .accuracy = 85,
    ...
    [MOVE_PSYCHO_CUT] =
    {
        ...
        .description = COMPOUND_STRING("It tears at the foe\n"
                                       "with psychic\n"
                                       "blades. It has a\n"
                                       "high critical ratio."),
        .animScript = gMoveAnim_PSYCHO_CUT,
        .effect = EFFECT_HIT,
        .power = 70,
        .type = TYPE_PSYCHIC,
        .accuracy = 100,
    ...
    [MOVE_ZEN_HEADBUTT] =
    {
        ...
        .description = COMPOUND_STRING("The user focuses\n"
                                       ...
                                       "its head. It may\n"
                                       "make the foe flinch."),
        .animScript = gMoveAnim_ZEN_HEADBUTT,
        .effect = EFFECT_HIT,
        .power = 80,
        .type = TYPE_PSYCHIC,
        .accuracy = 90,
    ...
    [MOVE_MIRROR_SHOT] =
    {
        ...
        .description = COMPOUND_STRING("Looses a flash of\n"
                                       "energy from its\n"
                                       "body. It may lower\n"
                                       "the foe's accuracy."),
        .animScript = gMoveAnim_MIRROR_SHOT,
        .effect = EFFECT_HIT,
        .power = 65,
        .type = TYPE_STEEL,
        .accuracy = 85,
    ...
    [MOVE_SMACK_DOWN] =
    {
        ...
        .description = COMPOUND_STRING("It throws a stone\n"
                                       "to attack. A flying\n"
                                       "foe will fall to\n"
                                       "the ground when hit."),
        .animScript = gMoveAnim_SMACK_DOWN,
        .effect = EFFECT_HIT,
        .power = 50,
        .type = TYPE_ROCK,
        .accuracy = 100,
    ...
    [MOVE_STORM_THROW] =
    {
        ...
        .description = COMPOUND_STRING("It strikes the foe\n"
                                       ...
                                       "It always results\n"
                                       "in a critical hit."),
        .animScript = gMoveAnim_STORM_THROW,
        .effect = EFFECT_HIT,
        .power = 60,
        .type = TYPE_FIGHTING,
        .accuracy = 100,
        .pp = 10,
        .critStage = 3, // Aways critical
        .target = MOVE_TARGET_SELECTED,
        .flags =
        {
            .makesContact = TRUE,
    ...
    [MOVE_FLAME_BURST] =
    {
        ...
        .description = COMPOUND_STRING("It attacks with a\n"
                                       ...
                                       "also damages who is\n"
                                       "next to the foe."),
        .animScript = gMoveAnim_FLAME_BURST,
    ...
    [MOVE_SLUDGE_WAVE] =
    {
        ...
        .description = COMPOUND_STRING("It swamps the area\n"
                                       ...
                                       "wave. It may also\n"
                                       "poison those hit."),
        .animScript = gMoveAnim_SLUDGE_WAVE,
        .effect = EFFECT_HIT,
        .power = 95,
        .type = TYPE_POISON,
        .accuracy = 100,
    ...
    [MOVE_QUIVER_DANCE] =
    {
        ...
        .description = COMPOUND_STRING("It lightly performs\n"
                                       "a dance. Boosting\n"
                                       "it's Sp. Atk,\n"
                                       "Sp. Def, and Speed."),
        .animScript = gMoveAnim_QUIVER_DANCE,
    ...
    [MOVE_HEAVY_SLAM] =
    {
        ...
        .description = COMPOUND_STRING("Slams the foe with\n"
                                       ...
                                       "it outweighs the\n"
                                       "foe, more damage."),
        .animScript = gMoveAnim_HEAVY_SLAM,
    ...
    [MOVE_SYNCHRONOISE] =
    {
        ...
        .description = COMPOUND_STRING("Using a shock wave,\n"
                                       "it damages Pokémon\n"
                                       "of the same type in\n"
                                       "the area around it."),
        .animScript = gMoveAnim_SYNCHRONOISE,
    ...
    [MOVE_ELECTRO_BALL] =
    {
        ...
        .description = COMPOUND_STRING("Hurls an electric\n"
                                       "orb at the foe. The\n"
                                       "faster the user,\n"
                                       "greater the damage."),
        .animScript = gMoveAnim_ELECTRO_BALL,
    ...
    [MOVE_FLAME_CHARGE] =
    {
        ...
        .description = COMPOUND_STRING("It cloaks itself\n"
                                       "with flame and\n"
                                       "attacks. It also\n"
                                       "raises it's Speed."),
        .animScript = gMoveAnim_FLAME_CHARGE,
        .effect = EFFECT_HIT,
        .power = 50,
        .type = TYPE_FIRE,
        .accuracy = 100,
    ...
    [MOVE_LOW_SWEEP] =
    {
        ...
        .description = COMPOUND_STRING("The user attacks\n"
                                       ...
                                       "swiftly, reducing\n"
                                       "the target's Speed."),
        .animScript = gMoveAnim_LOW_SWEEP,
        .effect = EFFECT_HIT,
        .power = 65,
        .type = TYPE_FIGHTING,
        .accuracy = 100,
    ...
    [MOVE_ACID_SPRAY] =
    {
        ...
        .description = COMPOUND_STRING("It spits fluid that\n"
                                       "works to melt the\n"
                                       "foe. It harshly\n"
                                       "lowers it's Sp. Def."),
        .animScript = gMoveAnim_ACID_SPRAY,
        .effect = EFFECT_HIT,
        .power = 40,
        .type = TYPE_POISON,
        .accuracy = 100,
    ...
    [MOVE_FOUL_PLAY] =
    {
        ...
        .description = COMPOUND_STRING("It turns the foe's\n"
                                       "power against it.\n"
                                       "The more the foe's\n"
                                       "Attack, more damage."),
        .animScript = gMoveAnim_FOUL_PLAY,
    ...
    [MOVE_SIMPLE_BEAM] =
    {
        ...
        .description = COMPOUND_STRING("It's mysterious\n"
                                       "psychic wave\n"
                                       "changes the foe's\n"
                                       "Ability to Simple."),
        .animScript = gMoveAnim_SIMPLE_BEAM,
        .effect = EFFECT_SET_ABILITY,
        .type = TYPE_NORMAL,
        .accuracy = 100,
        .pp = 15,
    ...
    [MOVE_ENTRAINMENT] =
    {
        ...
        .description = COMPOUND_STRING("It dances and the\n"
                                       "foe mimics it, turn\n"
                                       "the foe's Ability\n"
                                       "the same as their."),
        .animScript = gMoveAnim_ENTRAINMENT,
    ...
    [MOVE_AFTER_YOU] =
    {
        ...
        .description = COMPOUND_STRING("The user helps the\n"
                                       "target and makes it\n"
                                       "use its move right\n"
                                       "after the user."),
        .animScript = gMoveAnim_AFTER_YOU,
    ...
    [MOVE_CIRCLE_THROW] =
    {
        ...
        .description = COMPOUND_STRING("Throws the foe and\n"
                                       "drags out another.\n"
                                       "In the wild, the\n"
                                       "battle ends."),
        .animScript = gMoveAnim_CIRCLE_THROW,
    ...
    [MOVE_QUASH] =
    {
        ...
        .description = COMPOUND_STRING("The user suppresses\n"
                                       "the target and\n"
                                       "makes its move go\n"
                                       "last."),
        .animScript = gMoveAnim_QUASH,
        .effect = EFFECT_QUASH,
        .type = TYPE_DARK,
        .accuracy = 100,
        .pp = 15,
