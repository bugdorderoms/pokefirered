...
const struct Evolution gEvolutionTable[NUM_SPECIES][EVOS_PER_MON] =
{
    ...
    [SPECIES_PIKACHU]               = {{EVO_ITEM, ITEM_THUNDER_STONE, SPECIES_RAICHU},
                                       {EVO_MAPSEC, MAPSEC_POWER_PLANT, SPECIES_RAICHU_ALOLAN}},
    ...
    [SPECIES_MAGNETON]              = {{EVO_MAPSEC, MAPSEC_POWER_PLANT, SPECIES_MAGNEZONE},
    ...
    [SPECIES_EXEGGCUTE]             = {{EVO_ITEM, ITEM_LEAF_STONE, SPECIES_EXEGGUTOR},
                                       {EVO_MAPSEC, MAPSEC_VIRIDIAN_FOREST, SPECIES_EXEGGUTOR_ALOLAN}},
    ...
    [SPECIES_NOSEPASS]              = {{EVO_MAPSEC, MAPSEC_POWER_PLANT, SPECIES_PROBOPASS}},
    ...
    [SPECIES_TRANQUILL]             = {{EVO_LEVEL_MALE, 32, SPECIES_UNFEZANT},
	                                   {EVO_LEVEL_FEMALE, 32, SPECIES_UNFEZANT_FEMALE}},
    ...
    [SPECIES_FRILLISH]              = {{EVO_LEVEL_MALE, 40, SPECIES_JELLICENT},
		                               {EVO_LEVEL_FEMALE, 40, SPECIES_JELLICENT_FEMALE}},
    ...
    [SPECIES_SPEWPA]                = {{EVO_LEVEL_PERSONALITY, 12, SPECIES_VIVILLON}}, // handled by form change
    [SPECIES_LITLEO]                = {{EVO_LEVEL_MALE, 35, SPECIES_PYROAR},
		                               {EVO_LEVEL_FEMALE, 35, SPECIES_PYROAR_FEMALE}},
    [SPECIES_FLABEBE]               = {{EVO_LEVEL_PERSONALITY, 19, SPECIES_FLOETTE}}, // handled by form change
    ...
    [SPECIES_SLIGGOO]               = {{EVO_LEVEL_RAIN_OR_FOG, 50, SPECIES_GOODRA}},
    [SPECIES_PHANTUMP]              = {{EVO_ITEM, ITEM_LINKING_CORD, SPECIES_TREVENANT}},
    [SPECIES_PUMPKABOO]             = {{EVO_ITEM, ITEM_LINKING_CORD, SPECIES_GOURGEIST}},
    ...
    [SPECIES_TOXEL]                 = {{EVO_LEVEL_NATURE, 30, SPECIES_TOXTRICITY}}, // handled in form change
    ...
    [SPECIES_MILCERY]               = {{EVO_LEVEL_PERSONALITY, 28, SPECIES_ALCREMIE}}, // handled in form change, too many forms to do otherwise it, i'm not crazy ¬¬
    ...
    [SPECIES_KUBFU]                 = {{EVO_ITEM, ITEM_SCROLL_OF_DARKNESS, SPECIES_URSHIFU},
