...
const struct Fusion gFusionsTable[] =
{
	...
	FUSION(SPECIES_CALYREX,  SPECIES_GLASTRIER, ITEM_REINS_OF_UNITY, SPECIES_CALYREX_ICE_RIDER),
	FUSION(SPECIES_CALYREX,  SPECIES_SPECTRIER, ITEM_REINS_OF_UNITY, SPECIES_CALYREX_SHADOW_RIDER),
