const struct CompressedSpriteSheet gMonBackPicTable[] =
{
    ...
    SPECIES_SPRITE(MINIOR, gMonBackPic_MiniorCore),
	...
	SPECIES_SPRITE(UNFEZANT_FEMALE, gMonBackPic_UnfezantFemale),
    ...
    SPECIES_SPRITE(PYROAR_FEMALE, gMonBackPic_PyroarFemale),
    ...
    SPECIES_SPRITE(MINIOR_METEOR, gMonBackPic_Minior),
