...
// static const u8 ALIGNED(4) sBurstTriggerGfx[] = INCBIN_U8("graphics/battle_interface/gimmicks/burst_trigger.4bpp");
...
// static const u16 sBurstTriggerPal[] = INCBIN_U16("graphics/battle_interface/gimmicks/burst_trigger.gbapal");
