...
const struct BattleBackground gBattleTerrainTable[BATTLE_TERRAINS_COUNT] =
{
    [BATTLE_TERRAIN_GRASS] =
    {
        ...
        .introSlideFunc = BattleIntroSlide1,
        .naturePowerMove = MOVE_STUN_SPORE,
        .camouflageType = TYPE_GRASS,
        .camouflageBlendColor = RGB(12, 24, 2),
        .secretPowerEffect = MOVE_EFFECT_POISON,
    },
    [BATTLE_TERRAIN_LONG_GRASS] =
    {
        .name = COMPOUND_STRING("LONG GRASS"),
        ...
        .introSlideFunc = BattleIntroSlide1,
        .naturePowerMove = MOVE_RAZOR_LEAF,
        .camouflageType = TYPE_GRASS,
        .camouflageBlendColor = RGB(0, 15, 2),
    ...
    [BATTLE_TERRAIN_SAND] =
    {
        ...
        .introSlideFunc = BattleIntroSlide2,
        .naturePowerMove = MOVE_EARTHQUAKE,
        .camouflageType = TYPE_GROUND,
        .camouflageBlendColor = RGB(30, 24, 11),
    ...
    [BATTLE_TERRAIN_UNDERWATER] =
    {
        ...
        .introSlideFunc = BattleIntroSlide2,
        .naturePowerMove = MOVE_HYDRO_PUMP,
        .camouflageType = TYPE_WATER,
        .camouflageBlendColor = RGB(0, 0, 18),
    ...
    [BATTLE_TERRAIN_WATER] =
    {
        ...
        .introSlideFunc = BattleIntroSlide2,
        .naturePowerMove = MOVE_SURF,
        .camouflageType = TYPE_WATER,
        .camouflageBlendColor = RGB(11, 22, 31),
        .secretPowerEffect = MOVE_EFFECT_ATK_MINUS_1,
    },
    [BATTLE_TERRAIN_POND] =
    {
        .name = COMPOUND_STRING("POND"),
        ...
        .introSlideFunc = BattleIntroSlide1,
        .naturePowerMove = MOVE_BUBBLE_BEAM,
        .camouflageType = TYPE_WATER,
        .camouflageBlendColor = RGB(11, 22, 31),
    ...
    [BATTLE_TERRAIN_MOUNTAIN] =
    {
        ...
        .camouflageBlendColor = RGB(22, 16, 10),
    ...
    [BATTLE_TERRAIN_CAVE] =
    {
        ...
        .camouflageType = TYPE_ROCK,
        .camouflageBlendColor = RGB(14, 9, 3),
        .secretPowerEffect = MOVE_EFFECT_FLINCH,
    },
    [BATTLE_TERRAIN_BUILDING] =
    {
        .name = COMPOUND_STRING("BUILDING"),
        ...
        .introSlideFunc = BattleIntroSlide3,
        .naturePowerMove = MOVE_SWIFT,
        .camouflageType = TYPE_NORMAL,
        .camouflageBlendColor = RGB(31, 31, 31),
        .secretPowerEffect = MOVE_EFFECT_PARALYSIS,
    },
    [BATTLE_TERRAIN_PLAIN] =
    {
        .name = COMPOUND_STRING("PLAIN"),
        .tileset = sBattleTerrainTiles_Building,
        .tilemap = sBattleTerrainTilemap_Building,
        .entryTileset = sBattleTerrainAnimTiles_Building,
        .entryTilemap = sBattleTerrainAnimTilemap_Building,
