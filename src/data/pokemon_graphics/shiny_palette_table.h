const struct CompressedSpritePalette gMonShinyPaletteTable[] =
{
    ...
    SPECIES_SHINY_PAL(MINIOR, gMonShinyPalette_MiniorCore),
	...
	SPECIES_SHINY_PAL(UNFEZANT_FEMALE, gMonShinyPalette_UnfezantFemale),
    ...
    SPECIES_SHINY_PAL(PYROAR_FEMALE, gMonShinyPalette_PyroarFemale),
    ...
    SPECIES_SHINY_PAL(MINIOR_METEOR, gMonShinyPalette_Minior),
