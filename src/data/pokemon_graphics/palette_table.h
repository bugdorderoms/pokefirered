const struct CompressedSpritePalette gMonPaletteTable[] =
{
    ...
    SPECIES_PAL(MINIOR, gMonPalette_MiniorCoreRed),
	...
	SPECIES_PAL(UNFEZANT_FEMALE, gMonPalette_UnfezantFemale),
    ...
    SPECIES_PAL(PYROAR_FEMALE, gMonPalette_PyroarFemale),
    ...
    SPECIES_PAL(MINIOR_METEOR, gMonPalette_Minior),
