...
static void Task_VoltorbFlip_HandleInput(u8 taskId);
// Game sequence funcs
...
static void Task_VoltorbFlip_WaitFadeIn(u8 taskId)
{
...
static void Task_RunCardFlipSequence(u8 taskId)
{
...
static void Task_VoltorbFlip_RunGameClearSequence(u8 taskId)
{
	s16 *data = gTasks[taskId].data;
...
static void Task_VoltorbFlip_RunGameLoseSequence(u8 taskId)
{
	s16 *data = gTasks[taskId].data;
...
static void Task_VoltorbFlip_RunGameQuitSequence(u8 taskId)
{
	s16 *data = gTasks[taskId].data;
...
static void Task_VoltorbFlip_RunEarnedMaxCoinsSequence(u8 taskId)
{
	s16 *data = gTasks[taskId].data;
