...
{
    {TYPE_MUL_NORMAL, TYPE_MUL_NORMAL, TYPE_MUL_NORMAL, TYPE_MUL_NORMAL, TYPE_MUL_NORMAL, TYPE_MUL_NOT_EFFECTIVE, TYPE_MUL_NORMAL, TYPE_MUL_NO_EFFECT, TYPE_MUL_NOT_EFFECTIVE, TYPE_MUL_NORMAL, TYPE_MUL_NORMAL, TYPE_MUL_NORMAL, TYPE_MUL_NORMAL, TYPE_MUL_NORMAL, TYPE_MUL_NORMAL, TYPE_MUL_NORMAL, TYPE_MUL_NORMAL, TYPE_MUL_NORMAL},
    {TYPE_MUL_SUPER_EFFECTIVE, TYPE_MUL_NORMAL, TYPE_MUL_NOT_EFFECTIVE, TYPE_MUL_NOT_EFFECTIVE, TYPE_MUL_NORMAL, TYPE_MUL_SUPER_EFFECTIVE, TYPE_MUL_NOT_EFFECTIVE, TYPE_MUL_NO_EFFECT, TYPE_MUL_SUPER_EFFECTIVE, TYPE_MUL_NORMAL, TYPE_MUL_NORMAL, TYPE_MUL_NORMAL, TYPE_MUL_NORMAL, TYPE_MUL_NORMAL, TYPE_MUL_NOT_EFFECTIVE, TYPE_MUL_SUPER_EFFECTIVE, TYPE_MUL_NORMAL, TYPE_MUL_SUPER_EFFECTIVE},
    {TYPE_MUL_NORMAL, TYPE_MUL_SUPER_EFFECTIVE, TYPE_MUL_NORMAL, TYPE_MUL_NORMAL, TYPE_MUL_NORMAL, TYPE_MUL_NOT_EFFECTIVE, TYPE_MUL_SUPER_EFFECTIVE, TYPE_MUL_NORMAL, TYPE_MUL_NOT_EFFECTIVE, TYPE_MUL_NORMAL, TYPE_MUL_NORMAL, TYPE_MUL_NORMAL, TYPE_MUL_SUPER_EFFECTIVE, TYPE_MUL_NOT_EFFECTIVE, TYPE_MUL_NORMAL, TYPE_MUL_NORMAL, TYPE_MUL_NORMAL, TYPE_MUL_NORMAL},
    {TYPE_MUL_NORMAL, TYPE_MUL_NORMAL, TYPE_MUL_NORMAL, TYPE_MUL_NOT_EFFECTIVE, TYPE_MUL_NOT_EFFECTIVE, TYPE_MUL_NOT_EFFECTIVE, TYPE_MUL_NORMAL, TYPE_MUL_NOT_EFFECTIVE, TYPE_MUL_NO_EFFECT, TYPE_MUL_NORMAL, TYPE_MUL_NORMAL, TYPE_MUL_NORMAL, TYPE_MUL_SUPER_EFFECTIVE, TYPE_MUL_NORMAL, TYPE_MUL_NORMAL, TYPE_MUL_NORMAL, TYPE_MUL_NORMAL, TYPE_MUL_NORMAL},
    {TYPE_MUL_NORMAL, TYPE_MUL_NORMAL, TYPE_MUL_NO_EFFECT, TYPE_MUL_SUPER_EFFECTIVE, TYPE_MUL_NORMAL, TYPE_MUL_SUPER_EFFECTIVE, TYPE_MUL_NOT_EFFECTIVE, TYPE_MUL_NORMAL, TYPE_MUL_SUPER_EFFECTIVE, TYPE_MUL_NORMAL, TYPE_MUL_SUPER_EFFECTIVE, TYPE_MUL_NORMAL, TYPE_MUL_NOT_EFFECTIVE, TYPE_MUL_SUPER_EFFECTIVE, TYPE_MUL_NORMAL, TYPE_MUL_NORMAL, TYPE_MUL_NORMAL, TYPE_MUL_NORMAL},
    {TYPE_MUL_NORMAL, TYPE_MUL_NOT_EFFECTIVE, TYPE_MUL_SUPER_EFFECTIVE, TYPE_MUL_NORMAL, TYPE_MUL_NOT_EFFECTIVE, TYPE_MUL_NORMAL, TYPE_MUL_SUPER_EFFECTIVE, TYPE_MUL_NORMAL, TYPE_MUL_NOT_EFFECTIVE, TYPE_MUL_NORMAL, TYPE_MUL_SUPER_EFFECTIVE, TYPE_MUL_NORMAL, TYPE_MUL_NORMAL, TYPE_MUL_NORMAL, TYPE_MUL_NORMAL, TYPE_MUL_SUPER_EFFECTIVE, TYPE_MUL_NORMAL, TYPE_MUL_NORMAL},
    {TYPE_MUL_NORMAL, TYPE_MUL_NOT_EFFECTIVE, TYPE_MUL_NOT_EFFECTIVE, TYPE_MUL_NOT_EFFECTIVE, TYPE_MUL_NORMAL, TYPE_MUL_NORMAL, TYPE_MUL_NORMAL, TYPE_MUL_NOT_EFFECTIVE, TYPE_MUL_NOT_EFFECTIVE, TYPE_MUL_NORMAL, TYPE_MUL_NOT_EFFECTIVE, TYPE_MUL_NORMAL, TYPE_MUL_SUPER_EFFECTIVE, TYPE_MUL_NORMAL, TYPE_MUL_SUPER_EFFECTIVE, TYPE_MUL_NORMAL, TYPE_MUL_NORMAL, TYPE_MUL_SUPER_EFFECTIVE},
    {TYPE_MUL_NO_EFFECT, TYPE_MUL_NORMAL, TYPE_MUL_NORMAL, TYPE_MUL_NORMAL, TYPE_MUL_NORMAL, TYPE_MUL_NORMAL, TYPE_MUL_NORMAL, TYPE_MUL_SUPER_EFFECTIVE, TYPE_MUL_NORMAL, TYPE_MUL_NORMAL, TYPE_MUL_NORMAL, TYPE_MUL_NORMAL, TYPE_MUL_NORMAL, TYPE_MUL_NORMAL, TYPE_MUL_SUPER_EFFECTIVE, TYPE_MUL_NORMAL, TYPE_MUL_NORMAL, TYPE_MUL_NOT_EFFECTIVE},
    {TYPE_MUL_NORMAL, TYPE_MUL_NORMAL, TYPE_MUL_NORMAL, TYPE_MUL_NORMAL, TYPE_MUL_NORMAL, TYPE_MUL_SUPER_EFFECTIVE, TYPE_MUL_NORMAL, TYPE_MUL_NORMAL, TYPE_MUL_NOT_EFFECTIVE, TYPE_MUL_NORMAL, TYPE_MUL_NOT_EFFECTIVE, TYPE_MUL_NOT_EFFECTIVE, TYPE_MUL_NORMAL, TYPE_MUL_NOT_EFFECTIVE, TYPE_MUL_NORMAL, TYPE_MUL_SUPER_EFFECTIVE, TYPE_MUL_NORMAL, TYPE_MUL_NORMAL},
    {TYPE_MUL_NORMAL, TYPE_MUL_NORMAL, TYPE_MUL_NORMAL, TYPE_MUL_NORMAL, TYPE_MUL_NORMAL, TYPE_MUL_NORMAL, TYPE_MUL_NORMAL, TYPE_MUL_NORMAL, TYPE_MUL_NORMAL, TYPE_MUL_NORMAL, TYPE_MUL_NORMAL, TYPE_MUL_NORMAL, TYPE_MUL_NORMAL, TYPE_MUL_NORMAL, TYPE_MUL_NORMAL, TYPE_MUL_NORMAL, TYPE_MUL_NORMAL, TYPE_MUL_NORMAL},
...
void SpriteCB_FaintOpponentMon(struct Sprite *sprite)
{
    ...
    {
        species = GetUnownSpeciesId(GetMonData(&gEnemyParty[gBattlerPartyIndexes[battler]], MON_DATA_PERSONALITY));
...
u8 IsRunningFromBattleImpossible(void)
{
    ...
    for (i = 0; i < gBattlersCount; ++i)
    {
        if (side != GetBattlerSide(i) && GetBattlerAbility(i) == ABILITY_SHADOW_TAG)
        {
        ...
        if (side != GetBattlerSide(i) && GetBattlerAbility(gActiveBattler) != ABILITY_LEVITATE && !IS_BATTLER_OF_TYPE(gActiveBattler, TYPE_FLYING)
         && !IS_BATTLER_OF_TYPE(gActiveBattler, TYPE_GHOST) && GetBattlerAbility(i) == ABILITY_ARENA_TRAP)
        {
            gBattleScripting.battler = i;
            gLastUsedAbility = gBattleMons[i].ability;
            gBattleCommunication[MULTISTRING_CHOOSER] = 2;
...
static void HandleAction_UseMove(void)
{
     ...
     && gBattleMons[gSideTimers[side].followmeTarget].hp != 0)
    {
        gBattlerTarget = gSideTimers[side].followmeTarget;
          ...
          || gBattleMoves[gCurrentMove].target != MOVE_TARGET_USER) && ((GetBattlerAbility(*(gBattleStruct->moveTarget + gBattlerAttacker)) != ABILITY_LIGHTNING_ROD
          && gBattleMoves[gCurrentMove].type == TYPE_ELECTRIC) || (GetBattlerAbility(*(gBattleStruct->moveTarget + gBattlerAttacker)) != ABILITY_STORM_DRAIN
	  && gBattleMoves[gCurrentMove].type == TYPE_WATER)))
    {
        side = GetBattlerSide(gBattlerAttacker);
        for (gActiveBattler = 0; gActiveBattler < gBattlersCount; ++gActiveBattler)
            if (side != GetBattlerSide(gActiveBattler) && *(gBattleStruct->moveTarget + gBattlerAttacker) != gActiveBattler
	     && ((GetBattlerAbility(gActiveBattler) == ABILITY_LIGHTNING_ROD && gBattleMoves[gCurrentMove].type == TYPE_ELECTRIC) 
	     || (GetBattlerAbility(gActiveBattler) == ABILITY_STORM_DRAIN && gBattleMoves[gCurrentMove].type == TYPE_WATER))
