...
static void sub_8146060(void)
{
    ...
    {
        sMEventScreenData->monIconId = CreateMonIcon(GetIconSpecies(sMEventScreenData->buff3430Sub.iconSpecies), SpriteCallbackDummy, 0xDC, 0x14, 0);
    ...
    if (sMEventScreenData->wonderCard.maxStamps != 0 && sMEventScreenData->wonderCard.type == 1)
    {
        ...
        for (; r7 < sMEventScreenData->wonderCard.maxStamps; r7++)
        {
            ...
            {
                sMEventScreenData->cardIconAndShadowSprites[r7][1] = CreateMonIcon(GetIconSpecies(sMEventScreenData->buff3430Sub.stampData[0][r7]), SpriteCallbackDummy, 0xd8 - 32 * r7, 0x88, 0);
