...
const u16 gMissStringIds[] =
{
    ...
    [B_MSG_MAGNET_RISE_AVOID] = STRINGID_DEFEVADESMOVESWITHMAGNETRISE
};
...
const u16 gFirstTurnOfTwoStringIds[] =
{
    ...
    [B_MSG_VANISHED_INSTANTLY]  = STRINGID_ATKVANISHEDINSTANTLY,
    [B_MSG_TOOK_INTO_SKY]       = STRINGID_ATKTOOKDEFINTOSKY
};
...
const u16 gProtectLikeUsedStringIds[] =
{
    ...
    [B_MSG_MOVE_PROTECTED_TEAM] = STRINGID_CURRMOVEPROTECTEDATKTEAM
};
...
const u16 gSwitchInAbilitiesMsgStringIds[] =
{
    ...
    [B_MSG_ALERTED]                  = STRINGID_ALERTEDTOBUFF1BUFF2,
...
const u16 gHealingWishLunarDanceStringIds[] =
{
    ...
    [B_MSG_CLOAKED_IN_MOONLIGHT] = STRINGID_PKMNBECAMECLOAKEDINMOONLIGHT
};
...
const u16 gFormChangeAbilitiesStringIds[] =
{
    ...
    [B_MSG_TRANS_INTO_COMPLETE] = STRINGID_PKMNTRANSFORMINCOMPLETEFORME,
};
...
const u16 gSplitSwapMovesStringIds[] =
{
    ...
    [B_MSG_SWITCHED_ALL_STAT_CHANGES] = STRINGID_ATKSWITCHEDSTATCHANGES,
    [B_MSG_SHARED_ITS_GUARD]          = STRINGID_ATKSHAREDGUARDWITHTHETARGET,
    [B_MSG_SHARED_ITS_POWER]          = STRINGID_ATKSHAREDPOWERWITHTHETARGET
};
...
const u16 gSosCallStringIds[] =
{
    [B_MSG_CALLED_FOR_HELP] = STRINGID_EFFCALLEDFORHELP,
    [B_MSG_CALLED_ITS_ALLY] = STRINGID_EFFCALLEDITSALLY
};

const u16 gAdrenalineOrbUsedStringIds[] =
{
    [B_MSG_MAKES_WILD_NERVOUS] = STRINGID_THELASTITEMMAKESWILDNERVOUS,
...
const u16 gStartingStatusStringIds[] =
{
    ...
    [B_MSG_MIST_SHROUDED_TRAINER_TEAM]     = STRINGID_ATKTEAMSHROUDEDINMIST,
    [B_MSG_VEIL_CLOAKED_TRAINER_TEAM]      = STRINGID_ATKTEAMCLOAKEDINMYSTICALVEIL,
    [B_MSG_TWISTED_DIMENSIONS_PERMANENTLY] = STRINGID_PERMANENTLYTWISTEDDIMENSIONS,
    [B_MSG_GRAVITY_INTENSIFIED]            = STRINGID_GRAVITYINTENSIFIED,
    [B_MSG_CREATE_PERMANENT_BIZARRE_AREA]  = STRINGID_PERMANENTAREASWAPBUFF1BUFF2
};

const u16 gSetStatusFromArgumentStringIds[] =
{
    [B_MSG_GET_PUMPED]                  = STRINGID_ATKGETTINGPUMPED,
    ...
    [B_MSG_SURROUNDED_IN_VEIL_OF_WATER] = STRINGID_ATKSURROUNDEDWITHVEILOFWATER,
    [B_MSG_ABILITY_SUPPRESSED]          = STRINGID_DEFABILITYWASSUPPRESSED
};

const u16 gEndTurnHealStringIds[] =
{
    [B_MSG_ABSORBED_NUTRIENTS] = STRINGID_ATKABSORBEDNUTRIENTS,
    [B_MSG_BUFF1_RESTORED_HEALTH] = STRINGID_THEBUFF1RESTOREDATKHEALTH
};
...
{
    [B_MSG_FREED_FROM_EFFECT]             = STRINGID_ATKFREEDFROMBUFF1,
    [B_MSG_NO_MORE_ENCORED]               = STRINGID_ATKENCOREENDED,
    [B_MSG_NO_MORE_DISABLED]              = STRINGID_ATKDISABLEDNOMORE,
    [B_MSG_ELETROMAGNETISM_WORE_OFF]      = STRINGID_ATKELECTROMAGNETISMWOREOFF,
    [B_MSG_HEAL_BLOCK_WORE_OFF]           = STRINGID_ATKHEALBLOCKWOREOFF,
    [B_MSG_CAN_USE_ITEMS_AGAIN]           = STRINGID_ATKCANUSEITEMSAGAIN,
    [B_MSG_PERISH_COUNT_FELL]             = STRINGID_ATKPERISHCOUNTFELLTOBUFF1,
...
const u8 *const gBattleStringsTable[] =
{
    ...
    [STRINGID_PKMNFAINTED - BATTLESTRINGS_ID_ADDER]                   = COMPOUND_STRING("{B_SCR_ACTIVE_NAME_WITH_PREFIX} fainted!\p"),
    ...
    [STRINGID_PKMNSTOLEEFFLASTITEM - BATTLESTRINGS_ID_ADDER]          = COMPOUND_STRING("{B_SCR_ACTIVE_NAME_WITH_PREFIX} stole {B_EFF_NAME_WITH_PREFIX}'s {B_LAST_ITEM}!"),
    ...
    [STRINGID_PKMNGOTFREEOFBUFF1BUFF2 - BATTLESTRINGS_ID_ADDER]       = COMPOUND_STRING("{B_SCR_ACTIVE_NAME_WITH_PREFIX} got free of {B_BUFF1}'s {B_BUFF2}!"),
    [STRINGID_PKMNSHEDLEECHSEED - BATTLESTRINGS_ID_ADDER]             = COMPOUND_STRING("{B_SCR_ACTIVE_NAME_WITH_PREFIX} shed Leech Seed!"),
    [STRINGID_PKMNBLEWAWAYHAZARDS - BATTLESTRINGS_ID_ADDER]           = COMPOUND_STRING("{B_SCR_ACTIVE_NAME_WITH_PREFIX} blew away hazards!"),
    ...
    [STRINGID_ALERTEDTOBUFF1BUFF2 - BATTLESTRINGS_ID_ADDER]           = COMPOUND_STRING("It was alerted to {B_BUFF1}'s {B_BUFF2}!"),
    ...
    [STRINGID_EFFABLPREVENTSPARALYSIS - BATTLESTRINGS_ID_ADDER]       = COMPOUND_STRING("{B_EFF_NAME_WITH_PREFIX}'s {B_EFF_ABILITY} prevents paralysis!"),
    ...
    [STRINGID_STRONGWINDSWEAKENEDATTACK - BATTLESTRINGS_ID_ADDER]     = COMPOUND_STRING("The mysterious strong winds weakened the attack!"),
    [STRINGID_PKMNTRANSFORMINCOMPLETEFORME - BATTLESTRINGS_ID_ADDER]  = COMPOUND_STRING("{B_SCR_ACTIVE_NAME_WITH_PREFIX} transformed into its Complete Forme!"),
    [STRINGID_SENSETHEPRESENCEOFMANY - BATTLESTRINGS_ID_ADDER]        = COMPOUND_STRING("You sense the presence of many!"),
    [STRINGID_ATKSWITCHEDSTATCHANGES - BATTLESTRINGS_ID_ADDER]        = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} switched stat changes with the target!"),
    [STRINGID_PKMNKNOCKEDOFFEFFLASTITEM - BATTLESTRINGS_ID_ADDER]     = COMPOUND_STRING("{B_SCR_ACTIVE_NAME_WITH_PREFIX} knocked off {B_EFF_NAME_WITH_PREFIX}'s {B_LAST_ITEM}!"),
    [STRINGID_DEFSHAREDITSLASTITEMWITHATK - BATTLESTRINGS_ID_ADDER]   = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX} shared its {B_LAST_ITEM} with {B_ATK_NAME_WITH_PREFIX}!"),
    [STRINGID_EFFCALLEDFORHELP - BATTLESTRINGS_ID_ADDER]              = COMPOUND_STRING("{B_EFF_NAME_WITH_PREFIX} called for help!"),
    [STRINGID_EFFCALLEDITSALLY - BATTLESTRINGS_ID_ADDER]              = COMPOUND_STRING("{B_EFF_NAME_WITH_PREFIX} called its ally Pokémon!"),
    [STRINGID_ITSHELPDIDNTAPPEAR - BATTLESTRINGS_ID_ADDER]            = COMPOUND_STRING("Its help didn't appear!"),
    [STRINGID_PKMNAPPEARED - BATTLESTRINGS_ID_ADDER]                  = COMPOUND_STRING("{B_SCR_ACTIVE_NAME_WITH_PREFIX} appeared!"),
    [STRINGID_ATKAURAFLAREDTOLIFE - BATTLESTRINGS_ID_ADDER]           = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX}'s aura flared to life!"),
    [STRINGID_THELASTITEMMAKESWILDNERVOUS - BATTLESTRINGS_ID_ADDER]   = COMPOUND_STRING("The {B_LAST_ITEM} makes the wild Pokémon nervous!"),
    [STRINGID_ATKSURROUNDEDWITHVEILOFWATER - BATTLESTRINGS_ID_ADDER]  = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} surrounded itself with a veil of water!"),
    [STRINGID_THEBUFF1RESTOREDATKHEALTH - BATTLESTRINGS_ID_ADDER]     = COMPOUND_STRING("The {B_BUFF1} restored {B_ATK_NAME_WITH_PREFIX}'s health!"),
    [STRINGID_LEVITATEDWITHELECTROMAGNETISM - BATTLESTRINGS_ID_ADDER] = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} levitated with electromagnetism!"),
    [STRINGID_ATKELECTROMAGNETISMWOREOFF - BATTLESTRINGS_ID_ADDER]    = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX}'s electromagnetism wore off!"),
    [STRINGID_DEFEVADESMOVESWITHMAGNETRISE - BATTLESTRINGS_ID_ADDER]  = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX} evades Ground moves with Magnet Rise!"),
    [STRINGID_PKMNBLEWAWAYFOGWITHCURRMOVE - BATTLESTRINGS_ID_ADDER]   = COMPOUND_STRING("{B_SCR_ACTIVE_NAME_WITH_PREFIX} blew away the deep fog!"),
    [STRINGID_PKMNBLEWAWAYBARRIERS - BATTLESTRINGS_ID_ADDER]          = COMPOUND_STRING("{B_SCR_ACTIVE_NAME_WITH_PREFIX} blew away barriers!"),
    [STRINGID_ATKTWISTEDTHEDIMENSIONS - BATTLESTRINGS_ID_ADDER]       = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} twisted the dimensions!"),
    ...
    [STRINGID_PKMNBECAMECLOAKEDINMOONLIGHT - BATTLESTRINGS_ID_ADDER]  = COMPOUND_STRING("{B_SCR_ACTIVE_NAME_WITH_PREFIX} became cloaked in mystical moonlight!"),
    [STRINGID_EFFTRAPPEDBYSWIRLINGMAGMA - BATTLESTRINGS_ID_ADDER]     = COMPOUND_STRING("{B_EFF_NAME_WITH_PREFIX} became trapped by swirling magma!"),
    [STRINGID_BUTATKCANTUSETHEMOVE - BATTLESTRINGS_ID_ADDER]          = COMPOUND_STRING("But {B_ATK_NAME_WITH_PREFIX} can't use the move!"),
    [STRINGID_ATKVANISHEDINSTANTLY - BATTLESTRINGS_ID_ADDER]          = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} vanished instantly!"),
    [STRINGID_CURRMOVEPROTECTEDATKTEAM - BATTLESTRINGS_ID_ADDER]      = COMPOUND_STRING("{B_CURRENT_MOVE} protected {B_ATK_TEAM_PREFIX}!"),
    [STRINGID_ATKSHAREDGUARDWITHTHETARGET - BATTLESTRINGS_ID_ADDER]   = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} shared its guard with the target!"),
    [STRINGID_ATKSHAREDPOWERWITHTHETARGET - BATTLESTRINGS_ID_ADDER]   = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} shared its power with the target!"),
    [STRINGID_BIZARREAREASWAPBUFF1ANDBUFF2 - BATTLESTRINGS_ID_ADDER]  = COMPOUND_STRING("It created a bizarre area in which the {B_BUFF1} and {B_BUFF2} stats are swapped!"),
    [STRINGID_BUFF1OFFNORMALISEDBUFF2BUFF3 - BATTLESTRINGS_ID_ADDER]  = COMPOUND_STRING("{B_BUFF1} wore off, and {B_BUFF2} and {B_BUFF3} stats returned to normal!"),
    [STRINGID_PERMANENTAREASWAPBUFF1BUFF2 - BATTLESTRINGS_ID_ADDER]   = COMPOUND_STRING("A permanent bizarre area was created in which the {B_BUFF1} and {B_BUFF2} stats are swapped!"),
    [STRINGID_ATKBECAMENIMBLE - BATTLESTRINGS_ID_ADDER]               = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} became nimble!"),
    [STRINGID_DEFWASHURLEDINTOTHEAIR - BATTLESTRINGS_ID_ADDER]        = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX} was hurled into the air!"),
    [STRINGID_ATKFREEDFROMTELEKINESIS - BATTLESTRINGS_ID_ADDER]       = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} was freed from the telekinesis!"),
    [STRINGID_BIZARREAREABLOCKITEMEFFECTS - BATTLESTRINGS_ID_ADDER]   = COMPOUND_STRING("It created a bizarre area in which Pokémon's held items lose their effects!"),
    [STRINGID_BUFF1OFFNORMALISEDITEMEFFECTS - BATTLESTRINGS_ID_ADDER] = COMPOUND_STRING("{B_BUFF1} wore off, and held items' effects returned to normal!"),
    [STRINGID_EFFFELLSTRAIGHTDOWN - BATTLESTRINGS_ID_ADDER]           = COMPOUND_STRING("{B_EFF_NAME_WITH_PREFIX} fell straight down!"),
    [STRINGID_THEBURSTINGFLAMEHITDEF - BATTLESTRINGS_ID_ADDER]        = COMPOUND_STRING("The bursting flame hit {B_DEF_NAME_WITH_PREFIX}!"),
    [STRINGID_PKMNTRANSFORMEDINTOBUFF1TYPE - BATTLESTRINGS_ID_ADDER]  = COMPOUND_STRING("{B_SCR_ACTIVE_NAME_WITH_PREFIX} transformed into the {B_BUFF1} type!"),
    ...
    [STRINGID_ATKTOOKDEFINTOSKY - BATTLESTRINGS_ID_ADDER]             = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} took {B_DEF_NAME_WITH_PREFIX} into the sky!"),
    [STRINGID_PKMNFREEDFROMSKYDROP - BATTLESTRINGS_ID_ADDER]          = COMPOUND_STRING("{B_SCR_ACTIVE_NAME_WITH_PREFIX} was freed from the Sky Drop!"),
    [STRINGID_DEFMOVEWASPOSTPONED - BATTLESTRINGS_ID_ADDER]           = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX}'s move was postponed!"),
...
#define HANDLE_NICKNAME_STRING_CASE(battlerId)                                                                               \
    ...
    {                                                                                                                        \
        toCpy = GetEnemyPokemonPrefix(battlerId);                                                                            \
                                                                                                                             \
        while (*toCpy != EOS)                                                                                                \
        {                                                                                                                    \
            dst[dstId] = *toCpy;                                                                                             \
...
void BufferStringBattle(u32 battlerId, u32 stringId)
{
    ...
    case STRINGID_RETURNMON:
        if (GetBattlerSide(battlerId) == B_SIDE_PLAYER)
        {
            ...
            else if (gBattleStruct->hpScale == 1 || IsDoubleBattleForBattler(battlerId))
    ...
    case STRINGID_SWITCHINMON:
        ...
        {
            if (gBattleStruct->hpScale == 0 || IsDoubleBattleForBattler(gBattleScripting.battler))
                stringPtr = sText_GoPkmn;
    ...
    while (*src != EOS)
    {
        if (*src == PLACEHOLDER_BEGIN)
        {
            ...
            switch (*src)
            {
                ...
                COPY_TRAINER1_CLASS:
                    if (gTrainerBattleOpponent_A == TRAINER_UNION_ROOM)
                        toCpy = gTrainerClassTable[GetUnionRoomTrainerClass()].name;
                    else
                        toCpy = gTrainerClassTable[gTrainers[gTrainerBattleOpponent_A].trainerClass].name;
                    break;
                ...
                case B_TXT_DEF_NAME:
                    ...
                    toCpy = text;
                    break;
                case B_TXT_CURRENT_TRAINER_NAME:
            ...
            else if (*src == B_TXT_CURRENT_TRAINER_NAME)
            {
                if (copyTrainer1Name)
                {
                    copyTrainer1Name = FALSE;
                    dst[dstId++] = CHAR_SPACE;
                    goto COPY_TRAINER1_NAME;
                }
            }
        }
        else
    ...
    *dst = EOS;
    ...
    while (src[srcId] != B_BUFF_EOS)
    {
        ...
        case B_BUFF_MON_NICK_WITH_PREFIX:
            ...
            {
                StringAppend(dst, GetEnemyPokemonPrefix(src[srcId + 1]));
...
void BattlePutTextOnWindow(const u8 *text, u8 windowId)
{
    ...
    textInfo = sTextOnWindowsInfo_Normal[windowId];
    
    if (!(textFlags & B_TEXT_FLAG_WINDOW_CLEAR))
        FillWindowPixelBuffer(windowId, textInfo.fillValue);
    
    printerTemplate.currentChar = text;
    printerTemplate.windowId = windowId;
    printerTemplate.letterSpacing = textInfo.letterSpacing;
    printerTemplate.lineSpacing = textInfo.lineSpacing;
    printerTemplate.fgColor = textInfo.fgColor;
    printerTemplate.bgColor = textInfo.bgColor;
    printerTemplate.shadowColor = textInfo.shadowColor;
    
    if (textFlags & B_TEXT_FLAG_NPC_CONTEXT_FONT)
        printerTemplate.fontId = sNpcTextColorToFont[ContextNpcGetTextColor()];
    else
    {
        if (windowId >= B_WIN_MOVE_NAME_1 && windowId <= B_WIN_MOVE_NAME_4)
            printerTemplate.fontId = GetFontIdToFit(text, textInfo.fontId, printerTemplate.letterSpacing, 64);
        else
            printerTemplate.fontId = textInfo.fontId;
    }

    switch (windowId)
    {
    case B_WIN_VS_PLAYER ... B_WIN_VS_MULTI_PLAYER_4:
        x = (48 - GetStringWidth(printerTemplate.fontId, text, printerTemplate.letterSpacing)) / 2;
        break;
    case B_WIN_VS_OUTCOME_DRAW ... B_WIN_VS_OUTCOME_RIGHT:
        x = (64 - GetStringWidth(printerTemplate.fontId, text, printerTemplate.letterSpacing)) / 2;
        break;
    default:
        x = textInfo.x;
        break;
    ...
    if ((gBattleTypeFlags & (BATTLE_TYPE_LINK | BATTLE_TYPE_RECORDED)) || ((gBattleTypeFlags & BATTLE_TYPE_POKEDUDE) && windowId != B_WIN_OAK_OLD_MAN) || gTestRunnerEnabled)
