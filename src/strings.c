...
const u8 gText_FormsNextDataCancel[] = _("{DPAD_LEFTRIGHT}Forms {A_BUTTON}Next Data {B_BUTTON}Cancel");
...
const u8 gSaveStatName_Seen[] = _("Seen");
const u8 gSaveStatName_Caught[] = _("Caught");
const u8 gSaveStatName_Date[] = _("Date");
...
const u8 gStartMenu_TimeBoxClock[] = _("Time: ");
const u8 gText_Font2Colon[] = _("{FONT_NORMAL}:{FONT_SMALL}");
const u8 gText_Space[] = _(" ");
const u8 gStartMenuText_Bag[] = _("Bag");
const u8 gStartMenuText_Options[] = _("Options");
...
const u8 gText_FontSize2[] = _("{FONT_NORMAL}");
...
const u8 gText_YouAlreadyHaveThis[] = _("You already own that TM.{PAUSE_UNTIL_PRESS}");
const u8 gText_SingleTmBuy[] = _("{STR_VAR_1} {STR_VAR_3},\nThat will be ¥{STR_VAR_2}. Okay?");
...
const u8 gText_TmPurchased[] = _("Purchased");
...
const u8 gText_Remember[] = _("Remember");
const u8 gText_Forget[] = _("Forget");
...
const u8 gText_PkmnNoMovesToRemember[] = _("{STR_VAR_1} has no moves\nto remember.{PAUSE_UNTIL_PRESS}");
const u8 gText_PkmnCantForget[] = _("{STR_VAR_1} can't forget\nthe only move it has.{PAUSE_UNTIL_PRESS}");
const u8 gText_PkmnForgotMove[] = _("{STR_VAR_1} forgot\n{STR_VAR_2}.{PAUSE_UNTIL_PRESS}");
...
const u8 gText_PkmnDynamaxLevelRaised[] = _("{STR_VAR_1} Dynamax Level\nincreased.{PAUSE_UNTIL_PRESS}");
...
const u8 gText_Loses[] = _("loses");
const u8 gText_PkmnBaseVar2StatVar3[] = _("{STR_VAR_1}'s base {STR_VAR_2}\nstat was {STR_VAR_3}.{PAUSE_UNTIL_PRESS}");
const u8 gText_PkmnFriendshipWasVar2[] = _("{STR_VAR_1}'s friendship\nwas {STR_VAR_2}.{PAUSE_UNTIL_PRESS}");
const u8 gText_Increased[] = _("increased");
const u8 gText_Decreased[] = _("decreased");
...
const u8 gText_DoWhatWithMoves[] = _("Do what with the moves?");
...
const u8 gText_FuseWithWhich[] = _("Fuse with which Pokémon?");
const u8 gText_NoSpaceForDefuse[] = _("You have no room to\nseparate the Pokémon.{PAUSE_UNTIL_PRESS}");
const u8 gText_CantFuseWithPokemon[] = _("It cannot be fused with\nthat Pokémon.{PAUSE_UNTIL_PRESS}");
const u8 gText_AlreadyHaveFused[] = _("You already have a {STR_VAR_1}\nfused with a {STR_VAR_2}.{PAUSE_UNTIL_PRESS}");
const u8 gText_ChangeAbility[] = _("Would you like to change {STR_VAR_1}'s\nability to {STR_VAR_2}?");
const u8 gText_AbilityChanged[] = _("{STR_VAR_1}'s ability became\n{STR_VAR_2}!{PAUSE_UNTIL_PRESS}");
const u8 gText_ChangeNature[] = _("Would you like to change {STR_VAR_1}'s\nnature to {STR_VAR_2}?");
const u8 gText_NatureChanged[] = _("{STR_VAR_1}'s nature became\n{STR_VAR_2}!{PAUSE_UNTIL_PRESS}");
...
const u8 gText_BlewAwayFog[] = _("Blew away fog.");
...
const u8 gOtherText_DefaultForm[] = _("Default Form");
const u8 gText_DeoxysFormAttack[] = _("Attack Form");
const u8 gText_DeoxysFormDefense[] = _("Defense Form");
const u8 gText_DeoxysFormSpeed[] = _("Speed Form");
const u8 gText_RotomFormHeat[] = _("Heat Form");
const u8 gText_RotomFormWash[] = _("Wash Form");
const u8 gText_RotomFormFrost[] = _("Frost Form");
const u8 gText_RotomFormFan[] = _("Fan Form");
const u8 gText_RotomFormMow[] = _("Mow Form");
const u8 gText_PikachuFormRockStar[] = _("Rock Star");
const u8 gText_PikachuFormBelle[] = _("Belle");
const u8 gText_PikachuFormPopStar[] = _("Pop Star");
const u8 gText_PikachuFormPhd[] = _("Ph. D.");
const u8 gText_PikachuFormLibre[] = _("Libre");
const u8 gText_FurfrouFormHeartTrim[] = _("Heart Trim");
const u8 gText_FurfrouFormStarTrim[] = _("Star Trim");
const u8 gText_FurfrouFormDiamondTrim[] = _("Diamond Trim");
const u8 gText_FurfrouFormDebutanteTrim[] = _("Debutante Trim");
const u8 gText_FurfrouFormMatronTrim[] = _("Matron Trim");
const u8 gText_FurfrouFormDandyTrim[] = _("Dandy Trim");
const u8 gText_FurfrouFormLaReineTrim[] = _("La Reine Trim");
const u8 gText_FurfrouFormKabukiTrim[] = _("Kabuki Trim");
const u8 gText_FurfrouFormPharaohTrim[] = _("Pharaoh Trim");
...
const u8 gText_MoveOkBack[] = _("{DPAD_ANY}Move {A_BUTTON}Ok {B_BUTTON}Back {L_BUTTON}Case");
...
const u8 gUnknown_841B2A9[] = _("{FONT_SMALL}Max.{FONT_NORMAL} HP");
...
const u8 gUnknown_841B2DC[] = _("{FONT_SMALL}{PLUS}{FONT_NORMAL}");
const u8 gUnknown_841B2E5[] = _("{FONT_SMALL}-{FONT_NORMAL}");
...
const u8 gText_FormChangeItem[] = _("{STR_VAR_1} changed Forme!{PAUSE_UNTIL_PRESS}");
const u8 gText_ChooseForm[] = _("Choose {STR_VAR_1} Forme.");
