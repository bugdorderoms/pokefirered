...
const u8 gText_Font2Colon[] = _("{SIZE 2}:{SIZE 0}");
...
const u8 gText_CantThrowPokeBall_TwoMons[] = _("Cannot throw a ball!\nThere are two Pokémon out there!\p");
const u8 gUnknown_8416631[] = _("The Box is full.{PAUSE_UNTIL_PRESS}");
const u8 gText_CantThrowPokeBall_SemiInvulnerable[] = _("Cannot throw a ball!\nThere's no Pokémon in sight!\p");
...
const u8 gText_Nicknames[] =   _("Pokémon Nick");
...
const u8 gText_SkipNicknames[] = _("Skip");
const u8 gText_GiveNicknames[] = _("Give");
...
const u8 gText_CodeInvalid[] = _("Code invalid!");
const u8 gText_GiftAlreadyReceived[] = _("You already received the gift\nfrom the code {STR_VAR_1}!");
const u8 gText_ReceivedGift[] = _("You received the gift\nfrom the code {STR_VAR_1}.");
