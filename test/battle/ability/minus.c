...
DOUBLE_BATTLE_TEST("Minus boosts the user's Sp. Attack by 50% if ally has Plus", s16 damage)
{
    u32 allyAbility;
    ...
    GIVEN {
        ...
        OPPONENT(SPECIES_MANECTRIC) { Ability(ABILITY_MINUS); }
...
DOUBLE_BATTLE_TEST("Minus boosts the user's Sp. Attack by 50% if ally has Minus", s16 damage)
{
    u32 allyAbility;
